    ...
    <div className="min-h-screen bg-[#fafafa] text-zinc-950">
      ...
      <main className="mx-auto max-w-6xl px-4 pb-16 pt-10 sm:px-6">
        ...
        <section className="mt-10">
          <h2 className="text-lg font-semibold tracking-tight text-zinc-900">Sélection</h2>
          {products.length === 0 ? (
            <p className="mt-4 text-sm text-zinc-500">Aucun produit listé pour le moment.</p>
          ) : (
