...
export function BuyerPushNotificationsCard() {
  const t = useTranslations("buyerAccount.push")
  ...
  return (
    <BentoCard className="border-violet-200/70 p-6 dark:border-violet-900/40">
      <div className="flex gap-3">
        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-violet-600/10 text-violet-700 dark:text-violet-300">
