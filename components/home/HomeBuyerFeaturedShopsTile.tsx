...
import { buyerServiceTileClass } from "@/components/home/HomeBuyerServiceTiles"
...
export function HomeBuyerFeaturedShopsTile({ shops: _shops, badgeLabel, label, hint }: Props) {
