...
/** Blocks publish until merchant KYC is approved — direct link to verification. */
export function SupplierKycPublishBanner({
  allowed,
  reason,
  status,
  draftCount = 0,
  ...
  const t = useTranslations("supplierDashboard.kycPublish")
