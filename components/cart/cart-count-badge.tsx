...
export function CartCountBadge({ count, size = "md", className }: Props) {
  ...
  return (
    <span
      key={count}
      className={cn(
        "affisell-cart-count-badge pointer-events-none absolute z-10 flex items-center justify-center rounded-full font-black tabular-nums leading-none text-white",
