#!/usr/bin/env node
/**
 * Sync Phase 15 restaurant/museum booking keys from en.json into other locales.
 * Usage: node scripts/i18n-sync-booking-phase15.mjs
 */
...
const KEYS = {
  ...
  supplier: { booking: en.supplier.booking },
}
