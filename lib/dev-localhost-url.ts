...
export function resolveDevPort(env: EnvBag = process.env): number {
...
export function devLocalhostOrigin(env: EnvBag = process.env): string {
...
export function devLocalhostUrl(path = "", env: EnvBag = process.env): string {
...
export function isDevEnvPortAligned(env: EnvBag = process.env): boolean {
