...
const AFFISELL_PDP_BRAND: StorefrontPdpBrandClasses = {
  ...
  ctaPrimarySticky:
    "h-10 min-w-0 flex-1 rounded-full bg-gradient-to-r from-violet-600 to-fuchsia-600 px-2.5 text-[11px] font-bold text-white shadow-lg shadow-violet-500/25 sm:h-11 sm:flex-none sm:px-5 sm:text-sm",
  ctaSecondary:
  ...
  stickySecondaryBtn:
    "inline-flex h-10 min-w-0 flex-1 items-center justify-center rounded-full border border-violet-400/60 bg-white px-2.5 text-[11px] font-bold text-violet-800 sm:h-11 sm:flex-none sm:px-3 sm:text-xs dark:bg-zinc-900 dark:text-violet-200",
}
...
const STOREFRONT_PDP_BRAND: StorefrontPdpBrandClasses = {
  ...
  ctaPrimarySticky:
    "store-pdp-cta-primary h-10 min-w-0 flex-1 rounded-full px-2.5 text-[11px] font-bold sm:h-11 sm:flex-none sm:px-5 sm:text-sm",
  ctaSecondary:
  ...
  stickySecondaryBtn:
    "store-pdp-sticky-secondary inline-flex h-10 min-w-0 flex-1 items-center justify-center rounded-full border bg-white px-2.5 text-[11px] font-bold sm:h-11 sm:flex-none sm:px-3 sm:text-xs dark:bg-zinc-900",
}
