...
export const REQUIRED_TAXONOMY_PATH_SUFFIXES = [
  ...
  "Appareils électroniques > Communications > Téléphonie > Téléphones mobiles > Téléphones portables déverrouillés",
  "Équipements sportifs > Loisirs de plein air > Trottinettes",
  "Santé et beauté > Hygiène personnelle > Soin des cheveux > Casques à vapeur et bonnets chauffants",
  "Vêtements et accessoires > Vêtements > Sous-vêtements et chaussettes > Collants",
