...
describe("isStaticAppPathname", () => {
  it("treats app routes as static, not locales", () => {
    ...
    expect(isStaticAppPathname("/intelli")).toBe(true)
    ...
    expect(isStaticAppPathname("/battles")).toBe(true)
    expect(isStaticAppPathname("/fr/battles")).toBe(true)
    expect(isStaticAppPathname("/become-supplier")).toBe(true)
    expect(isStaticAppPathname("/fr/become-supplier")).toBe(true)
    expect(isStaticAppPathname("/bestsellers")).toBe(true)
    expect(isStaticAppPathname("/fr/bestsellers")).toBe(true)
