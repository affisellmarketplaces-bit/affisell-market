...
1.1. 联盟伙伴为**联盟佣金代理**：**以自己名义、代表供应商**行事，**不持有库存**，由供应商**直接发货**。

1.2. 其为面向最终客户的**名义销售方**：**向客户开具发票**并订立销售合同。供应商代其履行交付。

1.3. **非商业代理**：可**自由设定加价**并承担**商业风险**。

1.4. **以自己名义、代表供应商行事，不持有库存。**

1.5. 客户增值税按 checkout 时的**最终价格**计算。
