...
// node_modules/@medusajs/dashboard/dist/product-variant-manage-inventory-items-MJENUVPA.mjs
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var import_jsx_runtime2 = __toESM(require_jsx_runtime(), 1);
var ManageVariantInventoryItemsSchema = object({
  inventory: array(
    object({
      inventory_item_id: string().min(1, instance.t("products.variant.inventory.validation.itemId")),
      required_quantity: union([number(), string()])
...
function ManageVariantInventoryItemsForm({
  ...
  const filteredInventory = ((_a = variant.inventory_items) == null ? void 0 : _a.filter((i) => i.inventory)) || [];
  const form = useForm({
    defaultValues: {
...
//# sourceMappingURL=product-variant-manage-inventory-items-MJENUVPA-LED45JRQ.js.map
