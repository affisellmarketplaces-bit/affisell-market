...
// node_modules/@medusajs/dashboard/dist/customer-group-add-customers-UQS74UMG.mjs
var import_react = __toESM(require_react(), 1);
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var import_jsx_runtime2 = __toESM(require_jsx_runtime(), 1);
var AddCustomersSchema = object({
  customer_ids: array(string()).min(1)
});
var PAGE_SIZE = 10;
var AddCustomersForm = ({
  ...
  return (0, import_jsx_runtime.jsx)(RouteFocusModal.Form, { form, children: (0, import_jsx_runtime.jsxs)(
    KeyboundForm,
    {
      ...
      children: [
        (0, import_jsx_runtime.jsx)(RouteFocusModal.Header, { children: (0, import_jsx_runtime.jsx)("div", { className: "flex items-center justify-end gap-x-2", children: form.formState.errors.customer_ids && (0, import_jsx_runtime.jsx)(Hint, { variant: "error", children: form.formState.errors.customer_ids.message }) }) }),
...
//# sourceMappingURL=customer-group-add-customers-UQS74UMG-R5NFACUZ.js.map
