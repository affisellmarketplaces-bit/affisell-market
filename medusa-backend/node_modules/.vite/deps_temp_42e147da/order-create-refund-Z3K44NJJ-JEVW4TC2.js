...
// node_modules/@medusajs/dashboard/dist/order-create-refund-Z3K44NJJ.mjs
var import_react = __toESM(require_react(), 1);
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var import_react2 = __toESM(require_react(), 1);
var import_jsx_runtime2 = __toESM(require_jsx_runtime(), 1);
var import_jsx_runtime3 = __toESM(require_jsx_runtime(), 1);
var OrderBalanceSettlementSchema = object({
  settlement_type: _enum(["credit_line", "refund"]),
  refund: object({
    amount: object({
      value: string().or(number()).optional(),
      float: number().or(_null())
    }),
    ...
    KeyboundForm,
    {
      ...
      children: [
        (0, import_jsx_runtime2.jsx)(RouteDrawer.Body, { className: "flex-1 overflow-auto", children: (0, import_jsx_runtime2.jsxs)("div", { className: "flex flex-col gap-y-4", children: [
          !hasPaymentIdInSearchParams && (0, import_jsx_runtime2.jsxs)(
            Select,
            {
              dir: direction,
              value: paymentId,
              ...
              children: [
                ...
                (0, import_jsx_runtime2.jsx)(Select.Content, { children: payments.map((payment2) => {
                  var _a;
                  const totalRefunded = ((_a = payment2.refunds) == null ? void 0 : _a.reduce(
                    (acc, next) => next.amount + acc,
                    0
                  )) || 0;
          ...
          hasPaymentIdInSearchParams && (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center", children: [
            (0, import_jsx_runtime2.jsx)("span", { children: getLocaleAmount(
              payment.amount,
              payment.currency_code
            ) }),
          ...
          (0, import_jsx_runtime2.jsx)(
            Form.Field,
            {
              ...
              render: ({ field }) => {
                return (0, import_jsx_runtime2.jsxs)(Form.Item, { children: [
                  (0, import_jsx_runtime2.jsx)(Form.Label, { children: t2("fields.refundReason") }),
                  (0, import_jsx_runtime2.jsx)(Form.Control, { children: (0, import_jsx_runtime2.jsxs)(
                    Select,
                    {
                      ...
                      children: [
                        (0, import_jsx_runtime2.jsx)(Select.Trigger, { children: (0, import_jsx_runtime2.jsx)(Select.Value, {}) }),
                        (0, import_jsx_runtime2.jsx)(Select.Content, { children: refund_reasons == null ? void 0 : refund_reasons.map((reason) => (0, import_jsx_runtime2.jsx)(Select.Item, { value: reason.id, children: reason.label }, reason.id)) })
                      ]
                    }
                  ) }),
                  (0, import_jsx_runtime2.jsx)(Form.ErrorMessage, {})
...
//# sourceMappingURL=order-create-refund-Z3K44NJJ-JEVW4TC2.js.map
