...
// node_modules/@medusajs/dashboard/dist/api-key-management-create-ZIKQH43A.mjs
var import_react = __toESM(require_react(), 1);
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var import_jsx_runtime2 = __toESM(require_jsx_runtime(), 1);
var ApiKeyCreateSchema = object({
  title: string().min(1)
});
...
var ApiKeyCreateForm = ({ keyType }) => {
  ...
  const handleCopyToken = async () => {
    var _a;
    if (!(createdKey == null ? void 0 : createdKey.token)) {
      toast.error(t2("apiKeyManagement.create.copySecretTokenFailure"));
      return;
    }
    try {
      if (!window.isSecureContext || !((_a = navigator.clipboard) == null ? void 0 : _a.writeText)) {
...
//# sourceMappingURL=api-key-management-create-ZIKQH43A-W333FL6G.js.map
