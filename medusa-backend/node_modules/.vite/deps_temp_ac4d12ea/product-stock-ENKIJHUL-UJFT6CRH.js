...
// node_modules/@medusajs/dashboard/dist/product-stock-ENKIJHUL.mjs
...
var ProductStockLocationsSchema = external_exports.record(external_exports.string(), LocationQuantitySchema);
...
var ProductStockVariantSchema = external_exports.object({
  inventory_items: external_exports.record(external_exports.string(), ProductStockInventoryItemSchema)
});
var ProductStockSchema = external_exports.object({
  variants: external_exports.record(external_exports.string(), ProductStockVariantSchema)
});
var ProductStockForm = ({
  ...
  const onSubmit = form.handleSubmit(async (data) => {
        ...
        for (const [location_id, level] of Object.entries(item.locations)) {
          if (level.id) {
            ...
            if (wasChecked && !level.checked) {
              (_h = payload.delete) == null ? void 0 : _h.push(level.id);
            } else {
              const newQuantity = level.quantity !== "" ? castNumber(level.quantity) : 0;
              const originalQuantity = (_o = (_n = (_m = (_l = (_k = (_j = (_i = initialValues.current) == null ? void 0 : _i.variants) == null ? void 0 : _j[variantId]) == null ? void 0 : _k.inventory_items) == null ? void 0 : _l[inventory_item_id]) == null ? void 0 : _m.locations) == null ? void 0 : _n[location_id]) == null ? void 0 : _o.quantity;
              if (newQuantity !== originalQuantity) {
                (_p = payload.update) == null ? void 0 : _p.push({
                  inventory_item_id,
                  location_id,
          ...
          if (!level.id && level.quantity !== "") {
            (_q = payload.create) == null ? void 0 : _q.push({
              inventory_item_id,
              location_id,
    ...
    if ((((_r = payload.delete) == null ? void 0 : _r.length) ?? 0) > 0) {
      setIsPromptOpen(true);
      const confirm = await prompt({
        title: t2("general.areYouSure"),
        description: t2("inventory.stock.disablePrompt", {
          count: ((_s = payload.delete) == null ? void 0 : _s.length) ?? 0
        }),
...
//# sourceMappingURL=product-stock-ENKIJHUL-UJFT6CRH.js.map
