...
// node_modules/@medusajs/dashboard/dist/region-create-MAWABB23.mjs
var import_react = __toESM(require_react(), 1);
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var import_jsx_runtime2 = __toESM(require_jsx_runtime(), 1);
var CreateRegionSchema = object({
  name: string().min(1),
  currency_code: string().min(2, "Select a currency"),
  automatic_taxes: boolean(),
  is_tax_inclusive: boolean(),
  countries: array(object({ code: string(), name: string() })),
  payment_providers: array(string()).min(1)
});
var PREFIX = "cr";
var PAGE_SIZE = 50;
...
var RegionCreate = () => {
  ...
  return (0, import_jsx_runtime2.jsx)(RouteFocusModal, { children: !isLoading && store && (0, import_jsx_runtime2.jsx)(CreateRegionForm, { currencies: storeCurrencies }) });
};
export {
  RegionCreate as Component
};
//# sourceMappingURL=region-create-MAWABB23-KJRODETM.js.map
