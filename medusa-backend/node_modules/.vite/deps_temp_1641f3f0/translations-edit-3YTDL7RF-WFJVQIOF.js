...
} from "./chunk-373FDG6N.js";
import "./chunk-EGRHWZRV.js";
import {
  KeyboundForm
} from "./chunk-DP54EP6X.js";
import "./chunk-SACKWG2Y.js";
import {
  RouteFocusModal,
  useRouteModal
} from "./chunk-DSZGQSUF.js";
import "./chunk-7GJT5CY4.js";
import "./chunk-QQQI24PR.js";
import {
  t
...
// node_modules/@medusajs/dashboard/dist/translations-edit-3YTDL7RF.mjs
...
var EntityTranslationsSchema = external_exports.object({
  ...
  fields: external_exports.record(external_exports.string(), external_exports.string().optional())
});
var TranslationsFormSchema = external_exports.object({
  entities: external_exports.record(external_exports.string(), EntityTranslationsSchema)
});
    ...
    const columns = [
      ...
      columnHelper.column({
        ...
        cell: (context) => {
          ...
          return (0, import_jsx_runtime.jsx)(DataGrid.ReadonlyCell, { color: "normal", context, isMultiLine: true, children: (0, import_jsx_runtime.jsxs)("div", { className: "flex w-full items-start justify-between gap-x-2", children: [
            (0, import_jsx_runtime.jsx)(Text, { className: "text-ui-fg-subtle", weight: "plus", size: "small", children: originalValue }),
            originalValue.trim() && (0, import_jsx_runtime.jsx)(
              Copy,
              {
...
//# sourceMappingURL=translations-edit-3YTDL7RF-WFJVQIOF.js.map
