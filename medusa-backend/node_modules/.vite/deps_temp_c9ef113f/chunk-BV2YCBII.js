...
// node_modules/@medusajs/dashboard/dist/chunk-C7T6E7MD.mjs
...
var RuleValueFormField = ({
  ...
  const selectedValue = !Array.isArray(fieldRule.values) ? fieldRule.values : void 0;
    ...
    (0, import_jsx_runtime2.jsxs)("div", { className: fields.length ? "mt-6" : "", children: [
      ...
      !!fields.length && (0, import_jsx_runtime2.jsx)(
        Button,
        {
          ...
          onClick: () => {
            const indicesToRemove = fields.map((field, index) => {
...
//# sourceMappingURL=chunk-BV2YCBII.js.map
