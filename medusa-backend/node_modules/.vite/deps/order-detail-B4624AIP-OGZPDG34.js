import {
  By
} from "./chunk-HPAZCNXJ.js";
import "./chunk-S4XCFSZC.js";
import {
  formatPercentage
} from "./chunk-SPWGWFNU.js";
import {
  useCancelOrderEdit,
  useConfirmOrderEdit
} from "./chunk-KZZYQQJJ.js";
import {
  getLoyaltyPlugin
...
import {
  ...
  useClaims
} from "./chunk-SQCPH3UG.js";
import {
  useCancelExchange,
  useCancelExchangeRequest,
  useExchanges
} from "./chunk-G4RYKCSH.js";
import {
  getReturnableQuantity
} from "./chunk-PM26KX6Y.js";
import {
  DEFAULT_FIELDS
} from "./chunk-5TUQDGXQ.js";
import {
  useCancelReturn,
  useCancelReturnRequest,
  useReturns
} from "./chunk-IS77OL3W.js";
import {
  getCanceledOrderStatus,
  getOrderFulfillmentStatus,
  getOrderPaymentStatus
} from "./chunk-IHTWM332.js";
import {
  getLocaleAmount,
  getStylizedAmount,
  isAmountLessThenRoundingError
} from "./chunk-ULHUAURJ.js";
import "./chunk-7GJT5CY4.js";
import {
  getFormattedAddress,
  isSameAddress
...
import {
  TwoColumnPage
} from "./chunk-3HVLJ6RB.js";
import {
  useDate
} from "./chunk-HNYWGUEE.js";
import "./chunk-YRTQVEYM.js";
import {
  Thumbnail
} from "./chunk-62CZV24X.js";
import "./chunk-B5KOBJK3.js";
import "./chunk-UPGOECHU.js";
import {
  Skeleton,
  TwoColumnPageSkeleton
} from "./chunk-AXG2F3TN.js";
import "./chunk-HPGXK5DQ.js";
import {
  useCapturePayment,
  useMarkPaymentCollectionAsPaid,
  usePlugins
} from "./chunk-LD7TWLPS.js";
import "./chunk-T2M4UW4T.js";
import "./chunk-TY5M7C5H.js";
import "./chunk-C6GS3DEP.js";
import "./chunk-OGSBLY42.js";
import "./chunk-Z7YCLVBU.js";
import "./chunk-POBBOKAY.js";
import "./chunk-ARJWZLOE.js";
import "./chunk-SVB44GYX.js";
import "./chunk-KFNGK2OP.js";
import "./chunk-LE77WF5P.js";
import "./chunk-XAWLZQ3J.js";
import "./chunk-R43QHP6S.js";
import "./chunk-BY7VHYGO.js";
import "./chunk-KJD5FLZ4.js";
import {
  useCustomer
} from "./chunk-FBTLSTBC.js";
import "./chunk-N5QUHU3P.js";
import "./chunk-V6WL2KW7.js";
import "./chunk-F3EQ5RXV.js";
import {
  ordersQueryKeys,
  useCancelOrder,
  ...
  useOrderLineItems,
  useOrderPreview
} from "./chunk-BWONIXAR.js";
import {
  useReservationItems
} from "./chunk-3JUAV3TX.js";
import {
  useStockLocation
} from "./chunk-YFM3U2L4.js";
import "./chunk-QXGP7WK6.js";
import "./chunk-S47GG2W2.js";
import "./chunk-7OD3JE7O.js";
import "./chunk-IJNVMNZT.js";
import "./chunk-532UUOKT.js";
import "./chunk-WCS3RWJR.js";
import {
  ActionMenu
} from "./chunk-PHU53QTR.js";
import "./chunk-7A3SEMB6.js";
import "./chunk-YCBPSESL.js";
import "./chunk-YQRSOKFP.js";
import "./chunk-6BBZIKXA.js";
import "./chunk-XBYLDV6H.js";
import "./chunk-2SU74BB5.js";
...
import {
  ...
  toast,
  usePrompt
} from "./chunk-XG4NVSXW.js";
import {
  useExtension
} from "./chunk-7BUZUNHM.js";
import {
  format
} from "./chunk-SCNTGT6L.js";
...
// node_modules/@medusajs/dashboard/dist/order-detail-B4624AIP.mjs
...
var OrderActiveEditSection = ({
  ...
  const isPending = ((_a = orderPreview == null ? void 0 : orderPreview.order_change) == null ? void 0 : _a.status) === "pending";
      ...
      Popover.Content,
      {
        ...
        children: (0, import_jsx_runtime7.jsxs)("div", { className: "flex flex-col", children: [
          !!previous && (0, import_jsx_runtime7.jsxs)("div", { className: "p-3", children: [
            showComparison && (0, import_jsx_runtime7.jsx)("div", { className: "txt-compact-small-plus mb-1", children: t("labels.from") }),
            previous
          ] }),
          !!next && (0, import_jsx_runtime7.jsxs)("div", { className: "border-t-2 border-dotted p-3", children: [
            showComparison && (0, import_jsx_runtime7.jsx)("div", { className: "txt-compact-small-plus mb-1", children: t("labels.to") }),
            next
          ] })
        ] })
      }
  ...
  return (0, import_react2.useMemo)(() => {
    ...
    for (const payment of payments) {
      ...
      for (const refund of payment.refunds || []) {
        items.push({
          ...
          children: (0, import_jsx_runtime8.jsxs)("div", { className: "text-ui-fg-subtle flex flex-col gap-y-2", children: [
            (0, import_jsx_runtime8.jsx)(Text, { size: "small", children: getStylizedAmount(
              refund.amount,
              payment.currency_code
            ) }),
            refund.created_by && (0, import_jsx_runtime8.jsxs)("div", { className: "flex items-center gap-x-2 text-sm", children: [
              t("fields.by"),
              " ",
              (0, import_jsx_runtime8.jsx)(By, { id: refund.created_by })
            ] })
          ] })
        });
      }
    ...
    for (const fulfillment of order.fulfillments || []) {
      items.push({
        ...
        children: (0, import_jsx_runtime8.jsxs)("div", { className: "text-ui-fg-subtle flex flex-col gap-y-2", children: [
          (0, import_jsx_runtime8.jsx)(FulfillmentCreatedBody, { fulfillment }),
          fulfillment.created_by && (0, import_jsx_runtime8.jsxs)("div", { className: "flex items-center gap-x-2 text-sm", children: [
            t("fields.by"),
            " ",
            (0, import_jsx_runtime8.jsx)(By, { id: fulfillment.created_by })
          ] })
        ] })
      });
      ...
      if (fulfillment.shipped_at) {
        items.push({
          ...
          children: (0, import_jsx_runtime8.jsxs)("div", { className: "text-ui-fg-subtle flex flex-col gap-y-2", children: [
            (0, import_jsx_runtime8.jsx)(FulfillmentCreatedBody, { fulfillment }),
            fulfillment.marked_shipped_by && (0, import_jsx_runtime8.jsxs)("div", { className: "flex items-center gap-x-2 text-sm", children: [
              t("fields.by"),
              " ",
              (0, import_jsx_runtime8.jsx)(By, { id: fulfillment.marked_shipped_by })
            ] })
          ] })
        });
      }
    ...
    for (const ret of returns) {
      ...
      items.push({
        ...
        children: (0, import_jsx_runtime8.jsxs)("div", { className: "text-ui-fg-subtle flex flex-col gap-y-2", children: [
          ...
          ret.created_by && !ret.canceled_at && (0, import_jsx_runtime8.jsxs)("div", { className: "flex items-center gap-x-2 text-sm", children: [
            t("fields.by"),
            " ",
            (0, import_jsx_runtime8.jsx)(By, { id: ret.created_by })
          ] })
        ] })
      });
      if (ret.canceled_at) {
      ...
      if (ret.status === "received" || ret.status === "partially_received") {
        items.push({
          ...
          itemsToReturn: ret == null ? void 0 : ret.items,
          itemsMap,
          children: (0, import_jsx_runtime8.jsx)(ReturnBody, { orderReturn: ret, isCreated: false, isReceived: true })
        });
      }
    }
    for (const claim of claims) {
      ...
      items.push({
        ...
        itemsMap,
        children: (0, import_jsx_runtime8.jsxs)("div", { className: "text-ui-fg-subtle flex flex-col gap-y-2", children: [
          (0, import_jsx_runtime8.jsx)(ClaimBody, { claim, claimReturn }),
          claim.created_by && !claim.canceled_at && (0, import_jsx_runtime8.jsxs)("div", { className: "flex items-center gap-x-2 text-sm", children: [
            t("fields.by"),
            " ",
            (0, import_jsx_runtime8.jsx)(By, { id: claim.created_by })
          ] })
        ] })
      });
    }
    for (const exchange of exchanges) {
      ...
      items.push({
        ...
        itemsMap,
        children: (0, import_jsx_runtime8.jsxs)("div", { className: "text-ui-fg-subtle flex flex-col gap-y-2", children: [
          (0, import_jsx_runtime8.jsx)(ExchangeBody, { exchange, exchangeReturn }),
          exchange.created_by && !exchange.canceled_at && (0, import_jsx_runtime8.jsxs)("div", { className: "flex items-center gap-x-2 text-sm", children: [
            t("fields.by"),
            " ",
            (0, import_jsx_runtime8.jsx)(By, { id: exchange.created_by })
          ] })
        ] })
      });
    }
        ...
        items.push({
          title: (0, import_jsx_runtime8.jsx)(
            change_details_tooltip_default,
            {
              ...
              previous: (0, import_jsx_runtime8.jsx)("p", { className: "txt-compact-small text-ui-fg-subtle", children: getFormattedAddress({
                address: (_c = update.actions[0].details) == null ? void 0 : _c.old
              }).join(", ") }),
              next: (0, import_jsx_runtime8.jsx)("p", { className: "txt-compact-small text-ui-fg-subtle", children: getFormattedAddress({
                address: (_d = update.actions[0].details) == null ? void 0 : _d.new
              }).join(", ") })
            }
          ),
        ...
        items.push({
          title: (0, import_jsx_runtime8.jsx)(
            change_details_tooltip_default,
            {
              ...
              previous: (0, import_jsx_runtime8.jsx)("p", { className: "txt-compact-small text-ui-fg-subtle", children: getFormattedAddress({
                address: (_e = update.actions[0].details) == null ? void 0 : _e.old
              }).join(", ") }),
              next: (0, import_jsx_runtime8.jsx)("p", { className: "txt-compact-small text-ui-fg-subtle", children: getFormattedAddress({
                address: (_f = update.actions[0].details) == null ? void 0 : _f.new
              }).join(", ") })
            }
          ),
          timestamp: update.created_at,
        ...
        items.push({
          title: (0, import_jsx_runtime8.jsx)(
            change_details_tooltip_default,
            {
              ...
              previous: (0, import_jsx_runtime8.jsx)("p", { className: "txt-compact-small text-ui-fg-subtle", children: (_g = update.actions[0].details) == null ? void 0 : _g.old }),
              next: (0, import_jsx_runtime8.jsx)("p", { className: "txt-compact-small text-ui-fg-subtle", children: (_h = update.actions[0].details) == null ? void 0 : _h.new })
            }
          ),
          timestamp: update.created_at,
          children: (0, import_jsx_runtime8.jsxs)("div", { className: "text-ui-fg-subtle mt-2 flex gap-x-2 text-sm", children: [
    ...
    if (initialOrder.created_at) {
      const createdAt = {
        ...
        children: (0, import_jsx_runtime8.jsx)(Text, { size: "small", className: "text-ui-fg-subtle", children: getStylizedAmount(initialOrder.total, initialOrder.currency_code) })
      };
        ...
        children: [
          (0, import_jsx_runtime8.jsxs)("div", { className: "flex items-center justify-between", children: [
            (itemsToSend == null ? void 0 : itemsToSend.length) || (itemsToReturn == null ? void 0 : itemsToReturn.length) ? (0, import_jsx_runtime8.jsx)(
              ...
              {
                title: typeof title === "string" ? title : (title == null ? void 0 : title.toString()) || "",
                itemsToSend,
                itemsToReturn,
                itemsMap
              },
              typeof title === "string" ? title : title == null ? void 0 : title.toString()
...
var OrderEditBody = ({ edit }) => {
  ...
  const ItemChangeDetails = ({
    ...
    if (isLoading || isLoadingDeleted) {
      return (0, import_jsx_runtime8.jsx)(Text, { size: "small", className: "text-ui-fg-subtle", children: t("labels.loading") });
    }
    return (0, import_jsx_runtime8.jsx)("div", { className: "text-ui-fg-subtle flex flex-col divide-y divide-dashed", children: lineItems.map((orderItem) => {
      ...
      return (0, import_jsx_runtime8.jsxs)(
        "div",
        {
          ...
          children: [
            (0, import_jsx_runtime8.jsx)(Thumbnail, { src: lineItem.thumbnail }),
            (0, import_jsx_runtime8.jsxs)("div", { children: [
              ...
              lineItem.variant_sku && (0, import_jsx_runtime8.jsx)(Text, { size: "small", children: lineItem.variant_sku }),
              (0, import_jsx_runtime8.jsx)(Text, { size: "small", children: `${label}: ${itemChangeItem.count}` })
            ] })
          ]
        },
        orderItem.item_id
  ...
  return (0, import_jsx_runtime8.jsxs)("div", { className: "text-ui-fg-subtle flex flex-col items-start gap-y-2", children: [
    itemsAdded.totalCount > 0 && (0, import_jsx_runtime8.jsx)(
      change_details_tooltip_default,
      {
        title: `${t("labels.added")}: ${itemsAdded.totalCount}`,
        previous: (0, import_jsx_runtime8.jsx)(ItemChangeDetails, { itemChange: itemsAdded, version: edit.version })
      }
    ),
    itemsRemoved.totalCount > 0 && (0, import_jsx_runtime8.jsx)(
      change_details_tooltip_default,
      {
        title: `${t("labels.removed")}: ${itemsRemoved.totalCount}`,
        previous: (0, import_jsx_runtime8.jsx)(
          ItemChangeDetails,
          {
    ...
    edit.internal_note && (0, import_jsx_runtime8.jsx)("div", { className: "bg-ui-bg-component shadow-borders-base mt-2 w-fit rounded-r-2xl rounded-bl-md rounded-tl-xl px-3 py-1.5", children: (0, import_jsx_runtime8.jsx)(Text, { size: "xsmall", className: "text-ui-fg-subtle", children: edit.internal_note }) }),
    userId && (0, import_jsx_runtime8.jsxs)("div", { className: "flex items-center gap-x-2 text-sm", children: [
      t("fields.by"),
      " ",
      (0, import_jsx_runtime8.jsx)(By, { id: userId })
    ] })
  ] });
};
  ...
  return (0, import_jsx_runtime10.jsxs)("div", { className: "text-ui-fg-subtle grid grid-cols-2 items-start px-6 py-4", children: [
    ...
    (0, import_jsx_runtime10.jsxs)("div", { className: "flex flex-col gap-y-2", children: [
      ...
      phone && (0, import_jsx_runtime10.jsxs)("div", { className: "grid grid-cols-[1fr_20px] items-start gap-x-2", children: [
        ...
        (0, import_jsx_runtime10.jsx)("div", { className: "flex justify-end", children: (0, import_jsx_runtime10.jsx)(Copy, { content: phone, className: "text-ui-fg-muted" }) })
      ] })
    ] })
  ] });
};
      ...
      children: [
        (0, import_jsx_runtime12.jsxs)("div", { className: "flex items-start gap-x-4", children: [
          ...
          (0, import_jsx_runtime12.jsxs)("div", { children: [
            ...
            (0, import_jsx_runtime12.jsx)(Text, { size: "small", children: (_b = (_a = item.variant) == null ? void 0 : _a.options) == null ? void 0 : _b.map((o) => o.value).join(" · ") })
          ] })
        ] }),
...
var Fulfillment = ({
  ...
  const isPickUpFulfillment = ((_c = (_b = (_a = fulfillment.shipping_option) == null ? void 0 : _a.service_zone) == null ? void 0 : _b.fulfillment_set) == null ? void 0 : _c.type) === "pickup";
  ...
  const [sendNotification, setSendNotification] = (0, import_react5.useState)(
    !order.no_notification
  );
  const [showDeliveredPrompt, setShowDeliveredPrompt] = (0, import_react5.useState)(false);
  ...
  return (0, import_jsx_runtime12.jsxs)(Container, { className: "divide-y p-0", children: [
    ...
    (0, import_jsx_runtime12.jsxs)("div", { className: "text-ui-fg-subtle grid grid-cols-2 items-start px-6 py-4", children: [
      ...
      (0, import_jsx_runtime12.jsx)("div", { children: fulfillment.labels && fulfillment.labels.length > 0 ? (0, import_jsx_runtime12.jsx)("ul", { children: fulfillment.labels.map((tlink) => {
        ...
        if (hasTrackingUrl || hasLabelUrl) {
          return (0, import_jsx_runtime12.jsxs)("li", { children: [
            hasTrackingUrl && (0, import_jsx_runtime12.jsx)(
              "a",
              {
                ...
                className: "text-ui-fg-interactive hover:text-ui-fg-interactive-hover transition-fg",
                children: (0, import_jsx_runtime12.jsx)(Text, { size: "small", leading: "compact", as: "span", children: tlink.tracking_number })
              }
            ),
            hasTrackingUrl && hasLabelUrl && " - ",
            hasLabelUrl && (0, import_jsx_runtime12.jsx)(
              "a",
              {
                ...
                rel: "noopener noreferrer",
                className: "text-ui-fg-interactive hover:text-ui-fg-interactive-hover transition-fg",
                children: (0, import_jsx_runtime12.jsx)(Text, { size: "small", leading: "compact", as: "span", children: "Label" })
              }
            )
    ...
    (0, import_jsx_runtime12.jsx)(Prompt, { open: showDeliveredPrompt, variant: "confirmation", children: (0, import_jsx_runtime12.jsxs)(Prompt.Content, { children: [
      (0, import_jsx_runtime12.jsxs)(Prompt.Header, { children: [
        (0, import_jsx_runtime12.jsx)(Prompt.Title, { children: t("general.areYouSure") }),
        (0, import_jsx_runtime12.jsx)(Prompt.Description, { children: t("orders.fulfillment.markAsDeliveredWarning") })
      ] }),
      (0, import_jsx_runtime12.jsxs)("div", { className: "border-ui-border-base mt-6 flex items-center justify-between border-y border-dotted p-6", children: [
        (0, import_jsx_runtime12.jsx)(
          Label,
          {
      ...
      (0, import_jsx_runtime12.jsxs)(Prompt.Footer, { children: [
        (0, import_jsx_runtime12.jsx)(Prompt.Cancel, { onClick: handleCancelDeliveredPrompt, children: t("actions.cancel") }),
        (0, import_jsx_runtime12.jsx)(Prompt.Action, { onClick: handleConfirmDelivered, children: t("actions.continue") })
      ] })
    ] }) })
  ] });
};
      ...
      (0, import_jsx_runtime15.jsxs)("div", { className: "flex items-center gap-x-2", children: [
        ...
        (0, import_jsx_runtime15.jsx)(Text, { size: "small", leading: "compact", children: (0, import_jsx_runtime15.jsx)(
          Trans,
          {
            ...
            components: [(0, import_jsx_runtime15.jsx)(display_id_default, { id: payment.id }, payment.id)]
          }
        ) })
      ] }),
...
var CopyPaymentLink = import_react8.default.forwardRef(
  ({ paymentCollection, order }, ref) => {
    const [done, setDone] = (0, import_react8.useState)(false);
    const [open, setOpen] = (0, import_react8.useState)(false);
    const [text, setText] = (0, import_react8.useState)("CopyPaymentLink");
    const { t } = useTranslation();
...
function ShippingInfoPopover({ shippingMethod }) {
  ...
  return (0, import_jsx_runtime18.jsx)(
    Tooltip,
    {
      ...
      children: (0, import_jsx_runtime18.jsx)(InformationCircleSolid, { className: "text-ui-fg-muted ml-1 inline-block" })
    }
  );
}
...
var OrderSummarySection = ({
  ...
  const receivableReturns = (0, import_react7.useMemo)(
    () => returns.filter((r) => !r.canceled_at),
    [returns]
  );
  const showReturns = !!receivableReturns.length;
  const showAllocateButton = (0, import_react7.useMemo)(() => {
    var _a2;
    if (!reservations) {
      return false;
    }
  ...
  return (0, import_jsx_runtime19.jsxs)(Container, { className: "divide-y divide-dashed p-0", children: [
    ...
    (0, import_jsx_runtime19.jsx)(DiscountAndTotalBreakdown, { order, plugins }),
...
var Item = ({
  ...
  const hasInventoryKit = isInventoryManaged && ((((_c = (_b = item.variant) == null ? void 0 : _b.inventory_items) == null ? void 0 : _c.length) || 0) > 1 || ((_e = (_d = item.variant) == null ? void 0 : _d.inventory_items) == null ? void 0 : _e.some(
  ...
  return (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
    (0, import_jsx_runtime19.jsxs)(
      "div",
      {
        ...
        children: [
          (0, import_jsx_runtime19.jsxs)("div", { className: " flex justify-between gap-x-2 ", children: [
            (0, import_jsx_runtime19.jsxs)("div", { className: " group flex items-start gap-x-4", children: [
              ...
              (0, import_jsx_runtime19.jsxs)("div", { children: [
                ...
                (0, import_jsx_runtime19.jsx)(Text, { size: "small", children: (_g = (_f = item.variant) == null ? void 0 : _f.options) == null ? void 0 : _g.map((o) => o.value).join(" · ") })
              ] })
            ] }),
            appliedPromoCodes.length > 0 && (0, import_jsx_runtime19.jsx)(
              Tooltip,
              {
                content: (0, import_jsx_runtime19.jsx)("span", { className: "text-pretty", children: appliedPromoCodes.map((code) => (0, import_jsx_runtime19.jsx)("div", { children: code }, code)) }),
                children: (0, import_jsx_runtime19.jsx)(ReceiptPercent, { className: "text-ui-fg-subtle flex-shrink self-center " })
              }
            )
          ] }),
...
var ItemBreakdown = ({
  ...
  const reservationsMap = (0, import_react7.useMemo)(
...
var CostBreakdown = ({
  ...
  const { t } = useTranslation();
  const [isTaxOpen, setIsTaxOpen] = (0, import_react7.useState)(false);
  const [isShippingOpen, setIsShippingOpen] = (0, import_react7.useState)(false);
  const taxCodes = (0, import_react7.useMemo)(() => {
    const taxCodeMap = {};
    order.items.forEach((item) => {
      var _a;
      (_a = item.tax_lines) == null ? void 0 : _a.forEach((line) => {
        var _a2;
        const currTotal = line.subtotal || 0;
        const prevTotal = ((_a2 = taxCodeMap[line.code]) == null ? void 0 : _a2.total) || 0;
    ...
    order.shipping_methods.forEach((sm) => {
      var _a;
      (_a = sm.tax_lines) == null ? void 0 : _a.forEach((line) => {
        var _a2;
        const currTotal = line.subtotal || 0;
        const prevTotal = ((_a2 = taxCodeMap[line.code]) == null ? void 0 : _a2.total) || 0;
        taxCodeMap[line.code] = {
      ...
      Cost,
      {
        label: (0, import_jsx_runtime19.jsxs)(
          "div",
          {
            ...
            children: [
              (0, import_jsx_runtime19.jsx)("span", { children: t("orders.summary.shippingSubtotal") }),
              (0, import_jsx_runtime19.jsx)(
                TriangleDownMini,
                {
                  style: {
    ...
    isShippingOpen && (0, import_jsx_runtime19.jsx)("div", { className: "flex flex-col gap-1 pl-5", children: (order.shipping_methods || []).sort(
      ...
      return (0, import_jsx_runtime19.jsxs)(
        "div",
        {
          ...
          children: [
            (0, import_jsx_runtime19.jsx)("div", { children: (0, import_jsx_runtime19.jsxs)("span", { className: "txt-small", children: [
              sm.name,
              ((_a = sm.detail) == null ? void 0 : _a.return_id) && ` (${t("fields.returnShipping")})`,
              " ",
            ...
            (0, import_jsx_runtime19.jsx)("span", { className: "txt-small text-ui-fg-muted", children: getLocaleAmount(sm.subtotal, order.currency_code) })
          ]
        },
        sm.id
      );
      ...
      (0, import_jsx_runtime19.jsxs)("div", { className: "flex justify-between", children: [
        (0, import_jsx_runtime19.jsxs)(
          "div",
          {
            ...
            children: [
              (0, import_jsx_runtime19.jsx)("span", { className: "txt-small select-none", children: t("orders.summary.taxTotal") }),
              hasTaxes && (0, import_jsx_runtime19.jsx)(
                TriangleDownMini,
                {
                  style: {
        ...
        (0, import_jsx_runtime19.jsx)("div", { className: "text-right", children: (0, import_jsx_runtime19.jsx)(Text, { size: "small", leading: "compact", children: getLocaleAmount(order.original_tax_total, order.currency_code) }) })
      ] }),
      isTaxOpen && (0, import_jsx_runtime19.jsx)("div", { className: "flex flex-col gap-1 pl-5", children: Object.entries(taxCodes).map(([code, { total, rate }]) => {
        return (0, import_jsx_runtime19.jsxs)(
          "div",
          {
            className: "flex items-center justify-between gap-x-2",
            children: [
              (0, import_jsx_runtime19.jsxs)("div", { className: "flex gap-1", children: [
                (0, import_jsx_runtime19.jsx)("span", { className: "txt-small", children: code }),
                (0, import_jsx_runtime19.jsxs)("span", { className: "txt-small", children: [
                  "(",
...
var DiscountAndTotalBreakdown = ({
  ...
  const { t } = useTranslation();
  const [isDiscountOpen, setIsDiscountOpen] = (0, import_react7.useState)(false);
  const [isCreditLinesOpen, setIsCreditLinesOpen] = (0, import_react7.useState)(false);
  const creditLines = order.credit_lines ?? [];
  const loyaltyPlugin = getLoyaltyPlugin(plugins);
  const discounts = (0, import_react7.useMemo)(() => {
    const discounts2 = [];
  ...
  return (0, import_jsx_runtime19.jsxs)("div", { className: "text-ui-fg-subtle flex flex-col gap-y-2 px-6 py-4", children: [
      ...
      Cost,
      {
        label: (0, import_jsx_runtime19.jsxs)(
          "div",
          {
            ...
            children: [
              (0, import_jsx_runtime19.jsx)("span", { children: t("orders.summary.discountTotal") }),
              hasDiscount && (0, import_jsx_runtime19.jsx)(
                TriangleDownMini,
                {
                  style: {
    ...
    isDiscountOpen && (0, import_jsx_runtime19.jsx)("div", { className: "flex flex-col gap-1 pl-5", children: discounts.map(({ type, total, codes }) => {
      return (0, import_jsx_runtime19.jsxs)(
        "div",
        {
          className: "flex items-center justify-between gap-x-2",
          children: [
            (0, import_jsx_runtime19.jsxs)("div", { className: "flex gap-1", children: [
              (0, import_jsx_runtime19.jsx)("span", { className: "txt-small", children: t(`fields.${type}`) }),
              (0, import_jsx_runtime19.jsxs)("span", { className: "txt-small", children: [
                "(",
                codes.join(", "),
                ")"
    ...
    hasCreditLines && (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
      (0, import_jsx_runtime19.jsx)(
        Cost,
        {
          label: (0, import_jsx_runtime19.jsxs)(
            "div",
            {
              ...
              className: "flex cursor-pointer items-center gap-1",
              children: [
                (0, import_jsx_runtime19.jsx)("span", { children: loyaltyPlugin ? t("orders.giftCardsStoreCreditLines") : t("orders.creditLines.title") }),
                (0, import_jsx_runtime19.jsx)(
                  TriangleDownMini,
                  {
                    style: {
      ...
      isCreditLinesOpen && (0, import_jsx_runtime19.jsx)("div", { className: "flex flex-col gap-1 pl-5", children: creditLines.map((creditLine) => {
        var _a;
        const prettyReference = (_a = creditLine.reference) == null ? void 0 : _a.split("_").join(" ").split("-").join(" ");
        return (0, import_jsx_runtime19.jsxs)(
          "div",
          {
            className: "flex items-center justify-between gap-x-2",
            children: [
              (0, import_jsx_runtime19.jsxs)("div", { className: "flex items-center", children: [
                (0, import_jsx_runtime19.jsx)(
                  Text,
                  {
                    size: "small",
                ...
                (0, import_jsx_runtime19.jsx)("span", { className: "txt-small text-ui-fg-subtle mx-1", children: "-" }),
                (0, import_jsx_runtime19.jsxs)(
                  Text,
                  {
                    size: "small",
    ...
    (0, import_jsx_runtime19.jsxs)("div", { className: "text-ui-fg-base flex items-center justify-between", children: [
      (0, import_jsx_runtime19.jsx)(Text, { className: "text-ui-fg-subtle", size: "small", leading: "compact", children: t("orders.summary.totalAfterDiscount") }),
      (0, import_jsx_runtime19.jsx)(
        Text,
        {
          className: "text-ui-fg-subtle text-bold",
  ...
  return (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
    ...
    isOpen && (0, import_jsx_runtime19.jsx)("div", { className: "flex flex-col gap-1 px-6 pb-4", children: inventory.map((i) => {
      ...
      return (0, import_jsx_runtime19.jsxs)(
        "div",
        {
          ...
          children: [
            (0, import_jsx_runtime19.jsx)("div", { children: (0, import_jsx_runtime19.jsxs)("span", { className: "txt-small text-ui-fg-subtle font-medium", children: [
              (_a2 = i.inventory) == null ? void 0 : _a2.title,
              ((_b = i.inventory) == null ? void 0 : _b.sku) && (0, import_jsx_runtime19.jsxs)("span", { className: "text-ui-fg-subtle font-normal", children: [
                " ",
                "⋅ ",
                (_c = i.inventory) == null ? void 0 : _c.sku
              ] })
            ] }) }),
            (0, import_jsx_runtime19.jsx)("div", { className: "relative flex-1", children: (0, import_jsx_runtime19.jsx)("div", { className: "bottom-[calc(50% - 2px)] absolute h-[1px] w-full border-b border-dashed" }) }),
        ...
        (_d = i.inventory) == null ? void 0 : _d.id
      );
    }) })
  ] });
};
...
var Total2 = ({ order }) => {
  ...
  return (0, import_jsx_runtime19.jsxs)("div", { className: " flex flex-col gap-y-2 px-6 py-4", children: [
    ...
    getTotalCreditLines(order.credit_lines ?? []) > 0 && (0, import_jsx_runtime19.jsxs)("div", { className: "text-ui-fg-base flex items-center justify-between", children: [
...
//# sourceMappingURL=order-detail-B4624AIP-OGZPDG34.js.map
