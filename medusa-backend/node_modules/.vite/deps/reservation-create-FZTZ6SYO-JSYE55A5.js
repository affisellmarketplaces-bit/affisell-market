...
// node_modules/@medusajs/dashboard/dist/reservation-create-FZTZ6SYO.mjs
var import_react = __toESM(require_react(), 1);
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var import_jsx_runtime2 = __toESM(require_jsx_runtime(), 1);
var CreateReservationSchema = object({
  inventory_item_id: string().min(1),
  location_id: string().min(1),
...
var ReservationCreate = () => {
  ...
  return (0, import_jsx_runtime2.jsx)(RouteFocusModal, { children: (0, import_jsx_runtime2.jsx)(ReservationCreateForm, { inventoryItemId: inventoryItemId ?? void 0 }) });
};
export {
  ReservationCreate as Component
};
//# sourceMappingURL=reservation-create-FZTZ6SYO-JSYE55A5.js.map
