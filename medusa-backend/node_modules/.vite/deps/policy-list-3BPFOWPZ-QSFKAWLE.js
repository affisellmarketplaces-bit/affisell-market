...
// node_modules/@medusajs/dashboard/dist/policy-list-3BPFOWPZ.mjs
  ...
  const { policies, count, isPending, isError, error } = useRbacPolicies(
    {
      ...
      resource: resource ? JSON.parse(resource) : void 0,
      operation: operation ? JSON.parse(operation) : void 0,
  ...
  return (0, import_react.useMemo)(() => {
    return [
      ...
      columnHelper.accessor("created_at", {
        ...
        cell: ({ row }) => (0, import_jsx_runtime.jsx)("span", { children: getFullDate({ date: row.original.created_at }) }),
        enableSorting: true,
...
var PolicyList = () => {
  ...
  return (0, import_jsx_runtime2.jsx)(
    SingleColumnPage,
    {
      ...
      children: (0, import_jsx_runtime2.jsx)(PolicyListTable, {})
    }
  );
};
export {
...
//# sourceMappingURL=policy-list-3BPFOWPZ-QSFKAWLE.js.map
