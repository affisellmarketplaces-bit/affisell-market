...
// node_modules/@medusajs/dashboard/dist/chunk-V2CZ23VK.mjs
...
var SalesChannelsCell = ({
  ...
  const { t } = useTranslation();
  const validChannels = salesChannels == null ? void 0 : salesChannels.filter(
    (sc) => sc != null
  );
  ...
  if (validChannels.length > 2) {
    return (0, import_jsx_runtime3.jsxs)("div", { className: "flex h-full w-full items-center gap-x-1 overflow-hidden", children: [
      (0, import_jsx_runtime3.jsx)("span", { className: "truncate", children: validChannels.slice(0, 2).map((sc) => sc.name).join(", ") }),
      (0, import_jsx_runtime3.jsx)(
        Tooltip,
        {
          content: (0, import_jsx_runtime3.jsx)("ul", { children: validChannels.slice(2).map((sc) => (0, import_jsx_runtime3.jsx)("li", { children: sc.name }, sc.id)) }),
  ...
  return (0, import_jsx_runtime3.jsx)("div", { className: "flex h-full w-full max-w-[250px] items-center overflow-hidden", children: (0, import_jsx_runtime3.jsx)("span", { title: channels, className: "truncate", children: channels }) });
};
...
//# sourceMappingURL=chunk-2RHXWZON.js.map
