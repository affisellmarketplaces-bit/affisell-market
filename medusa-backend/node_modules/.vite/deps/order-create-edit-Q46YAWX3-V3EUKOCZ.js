...
// node_modules/@medusajs/dashboard/dist/order-create-edit-Q46YAWX3.mjs
...
function OrderEditItem({ item, currencyCode, orderId }) {
  ...
  const appliedPromoCodes = (0, import_react5.useMemo)(() => {
      ...
      children: (0, import_jsx_runtime3.jsxs)("div", { className: "flex flex-col items-center gap-x-2 gap-y-2 p-3 text-sm md:flex-row", children: [
        ...
        (0, import_jsx_runtime3.jsxs)("div", { className: "flex flex-1 items-center justify-between", children: [
          (0, import_jsx_runtime3.jsxs)("div", { className: "flex flex-grow items-center gap-2", children: [
            ...
            appliedPromoCodes.length > 0 && (0, import_jsx_runtime3.jsx)("div", { className: "flex flex-shrink pt-[2px]", children: (0, import_jsx_runtime3.jsx)(
              Tooltip,
              {
                ...
                children: (0, import_jsx_runtime3.jsx)(ReceiptPercent, { className: "text-ui-fg-subtle font-normal" })
              }
            ) })
          ] }),
...
var OrderEditItemsSection = ({
  ...
  const filteredItems = (0, import_react2.useMemo)(() => {
    return preview.items.filter(
      (i) => {
        var _a;
        return i.title.toLowerCase().includes(filterTerm) || ((_a = i.product_title) == null ? void 0 : _a.toLowerCase().includes(filterTerm));
      }
    );
  }, [preview, filterTerm]);
...
var OrderEditCreateSchema = external_exports.object({
...
var OrderEditCreateForm = ({
  ...
  const handleSubmit = form.handleSubmit(async (data) => {
    ...
    try {
      ...
      if (data.note && ((_a2 = preview == null ? void 0 : preview.order_change) == null ? void 0 : _a2.id)) {
...
var OrderEditCreate = () => {
  ...
  const { mutateAsync: createOrderEdit } = useCreateOrderEdit((order == null ? void 0 : order.id) ?? "");
...
//# sourceMappingURL=order-create-edit-Q46YAWX3-V3EUKOCZ.js.map
