...
// node_modules/@medusajs/dashboard/dist/location-service-zone-shipping-option-create-LX2DJ2MI.mjs
    ...
    (0, import_jsx_runtime.jsxs)("div", { className: "grid grid-cols-1 gap-4 md:grid-cols-2", children: [
      ...
      (0, import_jsx_runtime.jsx)(
        Form.Field,
        {
          ...
          render: ({ field }) => {
            return (0, import_jsx_runtime.jsxs)(Form.Item, { children: [
              (0, import_jsx_runtime.jsx)(Form.Label, { children: t2("stockLocations.shippingOptions.fields.type") }),
              (0, import_jsx_runtime.jsx)(Form.Control, { children: (0, import_jsx_runtime.jsx)(
                Combobox,
                {
                  ...field,
...
var CreateShippingOptionDetailsSchema = external_exports.object({
  name: external_exports.string().min(1),
  price_type: external_exports.nativeEnum(ShippingOptionPriceType),
  enabled_in_store: external_exports.boolean(),
  shipping_profile_id: external_exports.string().min(1),
  provider_id: external_exports.string().min(1),
  fulfillment_option_id: external_exports.string().min(1),
  shipping_option_type_id: external_exports.string().min(1)
});
var ShippingOptionConditionalPriceSchema = external_exports.object({
  conditional_region_prices: external_exports.record(
    external_exports.string(),
    external_exports.array(ConditionalPriceSchema).optional()
  ),
  conditional_currency_prices: external_exports.record(
    external_exports.string(),
    external_exports.array(ConditionalPriceSchema).optional()
  )
});
var CreateShippingOptionSchema = external_exports.object({
  region_prices: external_exports.record(external_exports.string(), external_exports.string().optional()),
  currency_prices: external_exports.record(external_exports.string(), external_exports.string().optional())
...
//# sourceMappingURL=location-service-zone-shipping-option-create-LX2DJ2MI-FJ5KEXWI.js.map
