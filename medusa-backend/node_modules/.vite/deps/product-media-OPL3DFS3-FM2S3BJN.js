...
// node_modules/@medusajs/dashboard/dist/product-media-OPL3DFS3.mjs
...
var ProductMediaGallery = ({ product }) => {
  ...
  const handleDeleteCurrent = async () => {
    ...
    const mediaToKeep = ((_a = product.images) == null ? void 0 : _a.filter((i) => i.id !== current.id).map((i) => ({ id: i.id, url: i.url }))) || [];
  ...
  return (0, import_jsx_runtime2.jsxs)("div", { className: "flex shrink-0 items-center justify-center gap-x-2 border-t p-3", children: [
    (0, import_jsx_runtime2.jsx)(
      IconButton,
      {
        ...
        type: "button",
        onClick: prev,
        children: (0, import_jsx_runtime2.jsx)(TriangleLeftMini, { className: "rtl:rotate-180" })
      }
    ),
    (0, import_jsx_runtime2.jsx)("div", { className: "flex items-center gap-x-2", children: visibleItems.map((item) => {
      var _a;
      const isCurrentImage = item.id === ((_a = media[curr]) == null ? void 0 : _a.id);
    ...
    (0, import_jsx_runtime2.jsx)(
      IconButton,
      {
        ...
        type: "button",
        onClick: next,
        children: (0, import_jsx_runtime2.jsx)(TriangleRightMini, { className: "rtl:rotate-180" })
      }
    )
  ] });
};
...
//# sourceMappingURL=product-media-OPL3DFS3-FM2S3BJN.js.map
