...
import {
  getLinkedFields
} from "./chunk-D6NQ5FWS.js";
import "./chunk-AHFNDHOG.js";
import "./chunk-LEL55C57.js";
import "./chunk-CNIOETA3.js";
import "./chunk-ZF4IASQG.js";
import "./chunk-EGRHWZRV.js";
import "./chunk-YYVXJCZD.js";
...
// node_modules/@medusajs/dashboard/dist/product-detail-QSO2EX32.mjs
                  ...
                  actions: [
                    {
                      ...
                      icon: (0, import_jsx_runtime3.jsx)(GlobeEurope, {})
                    }
                  ]
                }
              ] : [],
...
var ProductMediaSection = ({ product }) => {
  ...
  const handleDelete = async () => {
    ...
    const includingThumbnail = ids.some(
      (id) => {
        var _a2;
        return (_a2 = media.find((m) => m.id === id)) == null ? void 0 : _a2.isThumbnail;
      }
    );
    const res = await prompt({
      title: t("general.areYouSure"),
    ...
    const mediaToKeep = (_a = product.images) == null ? void 0 : _a.filter((i) => !ids.includes(i.id)).map((i) => ({ id: i.id, url: i.url }));
    await mutateAsync(
      {
        images: mediaToKeep,
  ...
  return (0, import_jsx_runtime4.jsxs)(Container, { className: "divide-y p-0", children: [
    ...
    (0, import_jsx_runtime4.jsx)(CommandBar, { open: !!Object.keys(selection).length, children: (0, import_jsx_runtime4.jsxs)(CommandBar.Bar, { children: [
      ...
      Object.keys(selection).length === 1 && (0, import_jsx_runtime4.jsx)(
        CommandBar.Command,
        {
          action: () => {
...
var ProductSalesChannelSection = ({
  ...
  const { t } = useTranslation();
  const availableInSalesChannels = ((_a = product.sales_channels) == null ? void 0 : _a.filter((sc) => sc != null).map((sc) => ({
    id: sc.id,
    name: sc.name
  }))) ?? [];
...
var ProductVariantSection = ({
  ...
  variants == null ? void 0 : variants.forEach((variant) => {
        ...
        groups: [
          {
            actions: [
              ...
              ...isTranslationsEnabled ? [
                {
                  icon: (0, import_jsx_runtime8.jsx)(GlobeEurope, {}),
                  label: t("translations.actions.manage"),
  ...
  return (0, import_react2.useMemo)(() => {
    return [
      columnHelper.accessor("thumbnail", {
        ...
        maxSize: 72,
        cell: ({ row }) => {
          return (0, import_jsx_runtime8.jsx)("div", { className: "flex items-center pl-[1px]", children: (0, import_jsx_runtime8.jsx)(Thumbnail, { src: row.original.thumbnail }) });
        }
      }),
...
//# sourceMappingURL=product-detail-QSO2EX32-C5N2UNF3.js.map
