...
// node_modules/@medusajs/dashboard/dist/order-create-return-CXUBBN6Q.mjs
...
var AddReturnItemsTable = ({
  ...
  const alreadyAdded = (0, import_react3.useMemo)(() => new Set(selectedItems2), [selectedItems2]);
  const updater = (fn) => {
...
var ReturnCreateForm = ({
  ...
  const onShippingOptionChange = async (selectedOptionId) => {
    ...
    }).filter(Boolean).map((id) => deleteReturnShipping(id));
  ...
  (0, import_react2.useEffect)(() => {
    ...
    if (isShippingPriceEdit) {
      (_a = document.getElementById("js-shipping-input")) == null ? void 0 : _a.focus();
    }
  }, [isShippingPriceEdit]);
  (0, import_react2.useEffect)(() => {
  ...
  (0, import_react2.useEffect)(() => {
    const getInventoryMap = async () => {
      ...
      (await Promise.all(
        items.map(async (_i) => {
          const item = itemsMap.get(_i.item_id);
          if (!(item == null ? void 0 : item.variant_id) || !(item == null ? void 0 : item.product_id)) {
            return void 0;
          }
        ...
        var _a, _b;
        const { variant } = item;
        const levels = (_b = (_a = variant.inventory) == null ? void 0 : _a[0]) == null ? void 0 : _b.location_levels;
        if (!levels) {
          return;
        }
        ...
        (0, import_jsx_runtime4.jsx)(RouteFocusModal.Body, { className: "flex size-full justify-center overflow-y-auto", children: (0, import_jsx_runtime4.jsxs)("div", { className: "mt-16 w-[720px] max-w-[100%] px-4 md:p-0", children: [
          ...
          (0, import_jsx_runtime4.jsxs)("div", { className: "mt-8 border-y border-dotted py-4", children: [
            ...
            (0, import_jsx_runtime4.jsxs)("div", { className: "mt-4 flex items-center justify-between border-t border-dotted pt-4", children: [
              ...
              (0, import_jsx_runtime4.jsx)("span", { className: "txt-small font-medium", children: getStylizedAmount(estimatedDifference, order.currency_code) })
            ] })
          ] }),
...
var ReturnCreate = () => {
  ...
  const { mutateAsync: initiateReturn } = useInitiateReturn((order == null ? void 0 : order.id) ?? "");
...
//# sourceMappingURL=order-create-return-CXUBBN6Q-5BUNCYFA.js.map
