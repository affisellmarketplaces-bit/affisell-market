...
// node_modules/@medusajs/dashboard/dist/order-allocate-items-BXUNZX5J.mjs
var import_react = __toESM(require_react(), 1);
var import_react2 = __toESM(require_react(), 1);
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var import_jsx_runtime2 = __toESM(require_jsx_runtime(), 1);
var import_jsx_runtime3 = __toESM(require_jsx_runtime(), 1);
var AllocateItemsSchema = external_exports.object({
  location_id: external_exports.string(),
  quantity: external_exports.record(external_exports.string(), external_exports.number().or(external_exports.string()))
});
...
function OrderAllocateItemsItem({
  ...
  const hasInventoryKit = ((_b = item.variant) == null ? void 0 : _b.inventory_items) && checkInventoryKit(item);
  ...
  const hasQuantityError = !hasInventoryKit && availableQuantity && quantityField[`${item.id}-${(_d = (_c = item.variant) == null ? void 0 : _c.inventory) == null ? void 0 : _d[0].id}`] && (quantityField[`${item.id}-${(_f = (_e = item.variant) == null ? void 0 : _e.inventory) == null ? void 0 : _f[0].id}`] ?? 0) > availableQuantity;
  const minValue = 0;
  ...
  return (0, import_jsx_runtime.jsxs)("div", { className: "bg-ui-bg-subtle shadow-elevation-card-rest my-2 min-w-[720px] divide-y divide-dashed rounded-xl", children: [
              ...
              (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center gap-3", children: [
                ...
                (0, import_jsx_runtime.jsxs)("div", { className: "txt-small flex flex-col", children: [
                  ...
                  (0, import_jsx_runtime.jsxs)("span", { className: "text-ui-fg-muted", children: [
                    availableQuantity || "-",
                    availableQuantity && !hasInventoryKit && quantityField[`${item.id}-${(_h = (_g = item.variant) == null ? void 0 : _g.inventory) == null ? void 0 : _h[0].id}`] && (0, import_jsx_runtime.jsxs)("span", { className: "text-ui-fg-error txt-small ml-1", children: [
                      "-",
                      quantityField[`${item.id}-${(_j = (_i = item.variant) == null ? void 0 : _i.inventory) == null ? void 0 : _j[0].id}`]
                    ] })
                  ] })
                ] })
              ] }),
            ...
            (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center gap-3", children: [
              ...
              (0, import_jsx_runtime.jsxs)("div", { className: "text-ui-fg-subtle txt-small mr-2 flex flex-row items-center gap-2", children: [
                (0, import_jsx_runtime.jsx)(
                  ...
                  {
                    control: form.control,
                    name: hasInventoryKit ? `quantity.${item.id}-` : `quantity.${item.id}-${(_l = (_k = item.variant) == null ? void 0 : _k.inventory) == null ? void 0 : _l[0].id}`,
                    rules: {
                      ...
                      return (0, import_jsx_runtime.jsx)(Form.Item, { children: (0, import_jsx_runtime.jsx)(Form.Control, { children: (0, import_jsx_runtime.jsx)(
                        Input,
                        {
                          ...
                          onChange: (e) => {
                            ...
                            if (!((_b2 = (_a2 = item.variant) == null ? void 0 : _a2.inventory) == null ? void 0 : _b2[0])) {
                              return;
                            }
                            onQuantityChange(
    ...
    isOpen && ((_m = variant == null ? void 0 : variant.inventory) == null ? void 0 : _m.map((i, ind) => {
      var _a2, _b2, _c2, _d2, _e2;
      const location = (_a2 = i.location_levels) == null ? void 0 : _a2.find(
        (l) => l.location_id === locationId
      );
      const hasQuantityError2 = !!quantityField[`${item.id}-${i.id}`] && quantityField[`${item.id}-${i.id}`] > ((location == null ? void 0 : location.available_quantity) ?? 0);
        ...
        (0, import_jsx_runtime.jsxs)("div", { className: "flex flex-1 flex-row items-center gap-3", children: [
          ...
          (0, import_jsx_runtime.jsxs)("div", { className: "flex flex-col", children: [
            ...
            (0, import_jsx_runtime.jsx)("span", { className: "text-ui-fg-muted", children: t2("orders.allocateItems.requires", {
              num: (_c2 = (_b2 = variant.inventory_items) == null ? void 0 : _b2[ind]) == null ? void 0 : _c2.required_quantity
            }) })
          ] })
        ] }),
        (0, import_jsx_runtime.jsxs)("div", { className: "flex flex-1 flex-row justify-between", children: [
          ...
          (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center gap-3", children: [
            ...
            (0, import_jsx_runtime.jsxs)("div", { className: "text-ui-fg-subtle txt-small mr-1 flex flex-row items-center gap-2", children: [
              (0, import_jsx_runtime.jsx)(
                Form.Field,
                {
                  ...
                  rules: {
                    required: true,
                    min: 0,
                    max: (location == null ? void 0 : location.available_quantity) ?? 0
                  },
                  render: ({ field }) => {
                    return (0, import_jsx_runtime.jsx)(Form.Item, { children: (0, import_jsx_runtime.jsx)(Form.Control, { children: (0, import_jsx_runtime.jsx)(
                      Input,
              ...
              "/",
              " ",
              item.quantity * (((_e2 = (_d2 = variant.inventory_items) == null ? void 0 : _d2[ind]) == null ? void 0 : _e2.required_quantity) ?? 0),
              " ",
              t2("fields.qty")
            ] })
          ] })
...
function OrderAllocateItemsForm({ order }) {
  ...
  const itemsToAllocate = (0, import_react.useMemo)(
    () => order.items.filter(
      (item) => {
        var _a2, _b2, _c2;
        return ((_a2 = item.variant) == null ? void 0 : _a2.manage_inventory) && ((_c2 = (_b2 = item.variant) == null ? void 0 : _b2.inventory) == null ? void 0 : _c2.length) && item.quantity - item.detail.fulfilled_quantity > 0;
      }
    ),
    [order.items]
  );
  const filteredItems = (0, import_react.useMemo)(() => {
    return itemsToAllocate.filter(
      (i) => {
        var _a2, _b2;
        return ((_a2 = i.variant_title) == null ? void 0 : _a2.toLowerCase().includes(filterTerm)) || ((_b2 = i.product_title) == null ? void 0 : _b2.toLowerCase().includes(filterTerm));
      }
    );
    ...
    try {
      ...
      if (results.some((r) => !r.success)) {
        ...
        toast.error(t2("general.error"), {
          description: t2("orders.allocateItems.toast.error", {
            items: failedItems
          })
        });
      }
  ...
  const onQuantityChange = (inventoryItem, lineItem, hasInventoryKit, value, isRoot) => {
    ...
    if (value) {
      const location = (_a2 = inventoryItem.location_levels) == null ? void 0 : _a2.find(
    ...
    if (hasInventoryKit && isRoot) {
      ...
      (_c2 = (_b2 = item == null ? void 0 : item.variant) == null ? void 0 : _b2.inventory_items) == null ? void 0 : _c2.forEach((ii, ind) => {
        var _a3, _b3, _c3;
        const num = value || 0;
        const inventory = (_b3 = (_a3 = item.variant) == null ? void 0 : _a3.inventory) == null ? void 0 : _b3[ind];
        form.setValue(
          `quantity.${lineItem.id}-${inventory == null ? void 0 : inventory.id}`,
          num * (ii.required_quantity ?? 1)
        );
        if (value) {
          const location = (_c3 = inventory == null ? void 0 : inventory.location_levels) == null ? void 0 : _c3.find(
            (l) => l.location_id === selectedLocationId
          );
          if (location) {
            if ((location.available_quantity ?? 0) < value) {
...
function defaultAllocations(items) {
  ...
  items.forEach((item) => {
    var _a, _b, _c, _d, _e;
    const hasInventoryKit = ((_a = item.variant) == null ? void 0 : _a.inventory_items) && checkInventoryKit(item);
    ret[hasInventoryKit ? `${item.id}-` : `${item.id}-${(_c = (_b = item.variant) == null ? void 0 : _b.inventory) == null ? void 0 : _c[0].id}`] = "";
    if (hasInventoryKit) {
      (_e = (_d = item.variant) == null ? void 0 : _d.inventory) == null ? void 0 : _e.forEach((i) => {
        ret[`${item.id}-${i.id}`] = "";
      });
    }
  });
...
//# sourceMappingURL=order-allocate-items-BXUNZX5J-BEXPAFQ2.js.map
