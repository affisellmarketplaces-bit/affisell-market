...
// node_modules/@medusajs/dashboard/dist/chunk-HLYIVAII.mjs
...
var RequiredPermissionsSection = () => {
  ...
  if (!requirements.length) {
    return (0, import_jsx_runtime4.jsxs)(Container, { className: "flex flex-col gap-y-2 px-6 py-4", children: [
      (0, import_jsx_runtime4.jsx)(Heading, { level: "h2", children: t("permissions.requiredPermissions.title") }),
      (0, import_jsx_runtime4.jsx)(Text, { size: "small", className: "text-ui-fg-subtle", children: t("permissions.requiredPermissions.none") })
    ] });
  }
  return (0, import_jsx_runtime4.jsxs)(Container, { className: "flex flex-col gap-y-3 px-6 py-4", children: [
    (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center justify-between", children: [
      (0, import_jsx_runtime4.jsx)(Heading, { level: "h2", children: t("permissions.requiredPermissions.title") }),
      (0, import_jsx_runtime4.jsx)(Badge, { size: "2xsmall", rounded: "full", children: requirements.length })
    ] }),
    (0, import_jsx_runtime4.jsx)("div", { className: "flex flex-col gap-y-3", children: requirements.map((requirement) => {
      const key = [
      ...
      return (0, import_jsx_runtime4.jsxs)("div", { className: "flex flex-col gap-y-2", children: [
        (0, import_jsx_runtime4.jsx)(Text, { size: "small", className: "text-ui-fg-subtle", children: requirement.requireAll ? t("permissions.requiredPermissions.allOf") : t("permissions.requiredPermissions.anyOf") }),
        (0, import_jsx_runtime4.jsx)("div", { className: "flex flex-wrap gap-1.5", children: requirement.permissions.map((permission) => (0, import_jsx_runtime4.jsx)(Badge, { size: "2xsmall", children: permission }, permission)) }),
        requirement.source && (0, import_jsx_runtime4.jsx)(Text, { size: "xsmall", className: "text-ui-fg-muted", children: t("permissions.requiredPermissions.source", {
...
var Root = ({
   ...
   */
  requiredPermissionsSection = (0, import_jsx_runtime5.jsx)(RequiredPermissionsSection, {}),
  /**
  ...
  return (0, import_jsx_runtime5.jsxs)("div", { className: "flex w-full flex-col gap-y-3", children: [
    before.map((Component, i) => {
      return (0, import_react4.createElement)(Component, { ...widgetProps, key: i });
    }),
    (0, import_jsx_runtime5.jsxs)("div", { className: "flex w-full flex-col items-start gap-x-4 gap-y-3 xl:grid xl:grid-cols-[minmax(0,_1fr)_440px]", children: [
      (0, import_jsx_runtime5.jsxs)("div", { className: "flex w-full min-w-0 flex-col gap-y-3", children: [
        main,
        after.map((Component, i) => {
          return (0, import_react4.createElement)(Component, { ...widgetProps, key: i });
        }),
        showExtraData && (0, import_jsx_runtime5.jsxs)("div", { className: "hidden flex-col gap-y-3 xl:flex", children: [
          showMetadata && (0, import_jsx_runtime5.jsx)(MetadataSection, { data }),
          showJSON && (0, import_jsx_runtime5.jsx)(JsonViewSection, { data }),
          showJSON && requiredPermissionsSection
        ] })
      ] }),
      (0, import_jsx_runtime5.jsxs)("div", { className: "flex w-full flex-col gap-y-3 xl:mt-0", children: [
        ...
        showExtraData && (0, import_jsx_runtime5.jsxs)("div", { className: "flex flex-col gap-y-3 xl:hidden", children: [
          showMetadata && (0, import_jsx_runtime5.jsx)(MetadataSection, { data }),
          showJSON && (0, import_jsx_runtime5.jsx)(JsonViewSection, { data }),
          showJSON && requiredPermissionsSection
        ] })
    ...
    hasOutlet && (0, import_jsx_runtime5.jsx)(Outlet, {})
  ] });
};
var Main = ({
  children,
  ...
  return (0, import_jsx_runtime5.jsx)("div", { className: clx("flex w-full flex-col gap-y-3", className), ...props, children });
};
var Sidebar = ({
  children,
  className,
...
//# sourceMappingURL=chunk-3HVLJ6RB.js.map
