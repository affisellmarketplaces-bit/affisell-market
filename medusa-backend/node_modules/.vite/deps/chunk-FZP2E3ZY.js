...
// node_modules/@medusajs/dashboard/dist/chunk-ACMCHF5F.mjs
...
var CreateCampaignSchema = object({
  name: string().min(1),
  description: string().optional(),
  campaign_identifier: string().min(1),
  starts_at: date().nullable(),
  ends_at: date().nullable(),
  budget: object({
    attribute: string().nullish(),
    limit: number().min(0).nullish(),
    type: _enum([
      "spend",
      "usage",
      "use_by_attribute",
...
//# sourceMappingURL=chunk-FZP2E3ZY.js.map
