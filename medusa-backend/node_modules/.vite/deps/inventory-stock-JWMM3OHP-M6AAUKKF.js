...
// node_modules/@medusajs/dashboard/dist/inventory-stock-JWMM3OHP.mjs
...
var InventoryLocationsSchema = external_exports.record(external_exports.string(), LocationQuantitySchema);
var InventoryItemSchema = external_exports.object({
  locations: InventoryLocationsSchema
});
var InventoryStockSchema = external_exports.object({
  inventory_items: external_exports.record(external_exports.string(), InventoryItemSchema)
});
      ...
      for (const [location_id, level] of Object.entries(item.locations)) {
        if (level.id) {
          ...
          if (wasChecked && !level.checked) {
            (_f = payload.delete) == null ? void 0 : _f.push(level.id);
          } else {
            const newQuantity = level.quantity !== "" ? castNumber(level.quantity) : 0;
            const originalQuantity = (_k = (_j = (_i = (_h = (_g = initialValues.current) == null ? void 0 : _g.inventory_items) == null ? void 0 : _h[inventory_item_id]) == null ? void 0 : _i.locations) == null ? void 0 : _j[location_id]) == null ? void 0 : _k.quantity;
            if (newQuantity !== originalQuantity) {
              (_l = payload.update) == null ? void 0 : _l.push({
                id: level.id,
                inventory_item_id,
                location_id,
        ...
        if (!level.id && level.quantity !== "") {
          (_m = payload.create) == null ? void 0 : _m.push({
            inventory_item_id,
            location_id,
...
//# sourceMappingURL=inventory-stock-JWMM3OHP-M6AAUKKF.js.map
