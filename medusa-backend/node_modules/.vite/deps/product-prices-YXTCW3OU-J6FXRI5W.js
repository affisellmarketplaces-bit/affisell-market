...
// node_modules/@medusajs/dashboard/dist/product-prices-YXTCW3OU.mjs
...
var UpdateVariantPricesSchema = object({
  variants: array(
    object({
      ...
      prices: Object.entries(variant.prices || {}).filter(
        ...
        if (regionId) {
          existingId = (_c = (_b = (_a2 = variants == null ? void 0 : variants[ind]) == null ? void 0 : _a2.prices) == null ? void 0 : _b.find(
            (p) => {
              var _a3;
              return ((_a3 = p.rules) == null ? void 0 : _a3["region_id"]) === regionId;
            }
          )) == null ? void 0 : _c.id;
        } else {
...
//# sourceMappingURL=product-prices-YXTCW3OU-J6FXRI5W.js.map
