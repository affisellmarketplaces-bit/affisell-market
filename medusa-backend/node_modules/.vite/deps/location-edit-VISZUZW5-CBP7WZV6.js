...
// node_modules/@medusajs/dashboard/dist/location-edit-VISZUZW5.mjs
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var import_jsx_runtime2 = __toESM(require_jsx_runtime(), 1);
var EditLocationSchema = object({
  name: string().min(1),
  address: object({
...
var EditLocationForm = ({ location }) => {
  ...
  const handleSubmit = form.handleSubmit(async (values) => {
    ...
    await mutateAsync(
      ...
      {
        onSuccess: () => {
          toast.success(t2("stockLocations.edit.successToast", { name }));
          handleSuccess();
        },
        onError: (e) => {
...
//# sourceMappingURL=location-edit-VISZUZW5-CBP7WZV6.js.map
