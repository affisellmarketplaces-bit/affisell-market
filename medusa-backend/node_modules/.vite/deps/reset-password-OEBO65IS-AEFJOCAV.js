...
// node_modules/@medusajs/dashboard/dist/reset-password-OEBO65IS.mjs
...
var ResetPasswordInstructionsSchema = object({
  email: string().email()
});
var ResetPasswordSchema = object({
  password: string().min(1),
  repeat_password: string().min(1)
...
var ResetPasswordTokenSchema = object({
  entity_id: string(),
  provider: string(),
  exp: number(),
  iat: number()
...
//# sourceMappingURL=reset-password-OEBO65IS-AEFJOCAV.js.map
