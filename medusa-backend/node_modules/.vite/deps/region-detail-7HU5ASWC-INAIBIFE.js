...
// node_modules/@medusajs/dashboard/dist/region-detail-7HU5ASWC.mjs
...
var CountryActions = ({
  ...
  const prompt = usePrompt();
  const { mutateAsync } = useUpdateRegion(region.id);
  const payload = (_a = region.countries) == null ? void 0 : _a.filter((c) => c.iso_2 && c.iso_2 !== country.iso_2).map((c) => c.iso_2);
  ...
  return (0, import_jsx_runtime3.jsxs)(Container, { className: "divide-y p-0", children: [
    ...
    (0, import_jsx_runtime3.jsx)(
      SectionRow,
      {
        ...
        value: (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center gap-x-2", children: [
          ...
          (0, import_jsx_runtime3.jsx)(Text, { size: "small", leading: "compact", children: (_a = currencies[region.currency_code.toUpperCase()]) == null ? void 0 : _a.name })
        ] })
      }
    ),
    (0, import_jsx_runtime3.jsx)(
    ...
    (0, import_jsx_runtime3.jsx)(
      SectionRow,
      {
        ...
        value: (0, import_jsx_runtime3.jsx)("div", { className: "inline-flex", children: ((_b = region.payment_providers) == null ? void 0 : _b.length) ? (0, import_jsx_runtime3.jsx)(
          ListSummary,
          {
...
//# sourceMappingURL=region-detail-7HU5ASWC-INAIBIFE.js.map
