...
// node_modules/@medusajs/dashboard/dist/order-receive-return-Q5TF6Y2S.mjs
...
var ReceiveReturnSchema = external_exports.object({
  items: external_exports.array(
    external_exports.object({
      quantity: external_exports.number().nullish(),
      dismissed_quantity: external_exports.number().nullish(),
...
function DismissedQuantity({
  ...
  const [dismissedQuantity] = (0, import_react3.useMemo)(() => {
    var _a, _b;
    const dismissedAction = (_a = item.actions) == null ? void 0 : _a.find(
      (a) => a.action === "RECEIVE_DAMAGED_RETURN_ITEM"
    );
    return [(_b = dismissedAction == null ? void 0 : dismissedAction.details) == null ? void 0 : _b.quantity];
  }, [item]);
...
function OrderReceiveReturnForm({
  ...
  (0, import_react2.useEffect)(() => {
    previewItems == null ? void 0 : previewItems.sort((i1, i2) => i1.id.localeCompare(i2.id)).forEach((item, index) => {
      ...
      form.setValue(
        ...
        (_c = receivedAction == null ? void 0 : receivedAction.details) == null ? void 0 : _c.quantity,
        { shouldTouch: true, shouldDirty: true }
      );
      form.setValue(
        `items.${index}.dismissed_quantity`,
        (_d = dismissedAction == null ? void 0 : dismissedAction.details) == null ? void 0 : _d.quantity,
        { shouldTouch: true, shouldDirty: true }
      );
    });
  }, [previewItems]);
  ...
  const handleQuantityChange = async (itemId, value, index) => {
    ...
    if (typeof value === "number" && value < 0) {
      form.setValue(
        `items.${index}.quantity`,
        (_b = item == null ? void 0 : item.detail) == null ? void 0 : _b.return_received_quantity,
        { shouldTouch: true, shouldDirty: true }
      );
      toast.error(t2("orders.returns.receive.toast.errorNegativeValue"));
      return;
    ...
    if (typeof value === "number" && item && value > item.quantity) {
      form.setValue(
        `items.${index}.quantity`,
        (_c = item.detail) == null ? void 0 : _c.return_received_quantity,
        { shouldTouch: true, shouldDirty: true }
      );
...
//# sourceMappingURL=order-receive-return-Q5TF6Y2S-TTMQYKG2.js.map
