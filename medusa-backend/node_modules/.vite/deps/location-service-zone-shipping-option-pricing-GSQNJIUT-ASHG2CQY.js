...
// node_modules/@medusajs/dashboard/dist/location-service-zone-shipping-option-pricing-GSQNJIUT.mjs
var import_react = __toESM(require_react(), 1);
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var import_jsx_runtime2 = __toESM(require_jsx_runtime(), 1);
var EditShippingOptionPricingSchema = object({
  ...
  conditional_region_prices: record(
    string(),
    array(UpdateConditionalPriceSchema)
  ),
  conditional_currency_prices: record(
    string(),
    array(UpdateConditionalPriceSchema)
  )
});
function EditShippingOptionsPricingForm({
  ...
  const handleSubmit = form.handleSubmit(async (data2) => {
    ...
    const regionPrices = Object.entries(data2.region_prices).map(([region_id, value]) => {
      if (value === void 0 || value === "" || !(regions == null ? void 0 : regions.some((region) => region.id === region_id))) {
        return void 0;
      }
      const priceRecord = {
        region_id,
...
//# sourceMappingURL=location-service-zone-shipping-option-pricing-GSQNJIUT-ASHG2CQY.js.map
