...
// node_modules/@medusajs/dashboard/dist/order-create-exchange-XYY7APKS.mjs
...
var ExchangeCreateSchema = external_exports.object({
  inbound_items: external_exports.array(
    external_exports.object({
      item_id: external_exports.string(),
      variant_id: external_exports.string().nullish(),
      quantity: external_exports.number(),
      reason_id: external_exports.string().nullish(),
      note: external_exports.string().nullish()
    })
  ),
  outbound_items: external_exports.array(
    external_exports.object({
      item_id: external_exports.string(),
      variant_id: external_exports.string().nullish(),
      quantity: external_exports.number()
  ...
  location_id: external_exports.string().optional(),
  inbound_option_id: external_exports.string().nullish(),
  outbound_option_id: external_exports.string().nullish(),
  send_notification: external_exports.boolean().optional(),
  carry_over_promotions: external_exports.boolean().optional()
});
  ...
  const queriedItems = (0, import_react4.useMemo)(() => {
    ...
    if (q) {
      results = results.filter((i) => {
        var _a, _b, _c;
        return ((_a = i.product_title) == null ? void 0 : _a.toLowerCase().includes(q.toLowerCase())) || ((_b = i.variant_title) == null ? void 0 : _b.toLowerCase().includes(q.toLowerCase())) || ((_c = i.variant_sku) == null ? void 0 : _c.toLowerCase().includes(q.toLowerCase()));
      });
    }
    if (order) {
...
function ExchangeInboundItem({
  ...
  return (0, import_jsx_runtime3.jsxs)("div", { className: "bg-ui-bg-subtle shadow-elevation-card-rest my-2 rounded-xl ", children: [
    (0, import_jsx_runtime3.jsxs)("div", { className: "flex flex-col items-center gap-x-3 gap-y-2 p-3 text-sm md:flex-row", children: [
      (0, import_jsx_runtime3.jsxs)("div", { className: "flex flex-1 items-center gap-x-3", children: [
        ...
        (0, import_jsx_runtime3.jsxs)("div", { className: "flex flex-grow flex-col", children: [
        ...
        appliedPromoCodes.length > 0 && (0, import_jsx_runtime3.jsx)("div", { className: "flex flex-shrink", children: (0, import_jsx_runtime3.jsx)(
          Tooltip,
          {
            content: (0, import_jsx_runtime3.jsx)("span", { className: "text-pretty", children: appliedPromoCodes.map((code) => (0, import_jsx_runtime3.jsx)("div", { children: code }, code)) }),
            children: (0, import_jsx_runtime3.jsx)(ReceiptPercent, { className: "text-ui-fg-subtle" })
          }
        ) })
      ] }),
...
function ExchangeOutboundItem({
  ...
  return (0, import_jsx_runtime7.jsx)("div", { className: "bg-ui-bg-subtle shadow-elevation-card-rest my-2 rounded-xl ", children: (0, import_jsx_runtime7.jsxs)("div", { className: "flex flex-col items-center gap-x-3 gap-y-2 p-3 text-sm md:flex-row", children: [
    (0, import_jsx_runtime7.jsxs)("div", { className: "flex flex-1 items-center gap-x-3", children: [
      ...
      (0, import_jsx_runtime7.jsxs)("div", { className: "flex flex-grow flex-col", children: [
      ...
      appliedPromoCodes.length > 0 && (0, import_jsx_runtime7.jsx)("div", { className: "flex flex-shrink", children: (0, import_jsx_runtime7.jsx)(
        Tooltip,
        {
          content: (0, import_jsx_runtime7.jsx)("span", { className: "text-pretty", children: appliedPromoCodes.map((code) => (0, import_jsx_runtime7.jsx)("div", { children: code }, code)) }),
          children: (0, import_jsx_runtime7.jsx)(ReceiptPercent, { className: "text-ui-fg-subtle" })
        }
      ) })
    ] }),
...
var ExchangeOutboundSection = ({
  ...
  const outboundShippingOptions = shipping_options.filter(
    (so) => {
      var _a;
      return !((_a = so.rules) == null ? void 0 : _a.find((r) => r.attribute === "is_return" && r.value === "true"));
    }
  );
  ...
  return (0, import_jsx_runtime8.jsxs)("div", { children: [
    ...
    outboundItems.map(
      (item, index) => item.variant_id && variantOutboundMap.get(item.variant_id) && (0, import_jsx_runtime8.jsx)(
...
var ExchangeCreateForm = ({
  ...
  const { mutateAsync: updateOrderChange } = useUpdateOrderChange(
    (_a = preview == null ? void 0 : preview.order_change) == null ? void 0 : _a.id,
    {
      onError: (error) => {
        toast.error(error.message);
      }
  ...
  const hasPromotions = (0, import_react2.useMemo)(() => {
  ...
  const form = useForm({
    defaultValues: () => {
      ...
      const inboundShippingMethod = preview.shipping_methods.find((s) => {
        var _a3;
        return !!((_a3 = s.actions) == null ? void 0 : _a3.find(
          (a) => a.action === "SHIPPING_ADD" && !!a.return_id
        ));
      });
      ...
      return Promise.resolve({
        inbound_items: inboundPreviewItems.map((i) => {
          var _a3, _b;
          const inboundAction = (_a3 = i.actions) == null ? void 0 : _a3.find(
            (a) => a.action === "RETURN_ITEM"
          );
          return {
            item_id: i.id,
        ...
        carry_over_promotions: ((_a2 = preview == null ? void 0 : preview.order_change) == null ? void 0 : _a2.carry_over_promotions) ?? false
      });
    },
  ...
  const handleSubmit = form.handleSubmit(async (data) => {
    try {
      ...
      toast.error(t2("general.error"), {
        description: e instanceof Error ? e.message : t2("errorBoundary.defaultTitle")
      });
    }
  });
  (0, import_react2.useEffect)(() => {
    ...
    if (isInboundShippingPriceEdit) {
      (_a2 = document.getElementById("js-inbound-shipping-input")) == null ? void 0 : _a2.focus();
    }
  }, [isInboundShippingPriceEdit]);
  (0, import_react2.useEffect)(() => {
    var _a2;
    if (isOutboundShippingPriceEdit) {
      (_a2 = document.getElementById("js-outbound-shipping-input")) == null ? void 0 : _a2.focus();
    }
    ...
    (0, import_jsx_runtime9.jsx)(RouteFocusModal.Body, { className: "flex size-full justify-center overflow-y-auto", children: (0, import_jsx_runtime9.jsxs)("div", { className: "mt-16 w-[720px] max-w-[100%] px-4 md:p-0", children: [
      ...
      (0, import_jsx_runtime9.jsxs)("div", { className: "mt-8 border-y border-dotted py-4", children: [
        (0, import_jsx_runtime9.jsxs)("div", { className: "mb-2 flex items-center justify-between", children: [
          ...
          (0, import_jsx_runtime9.jsx)("span", { className: "txt-small text-ui-fg-subtle", children: getStylizedAmount(
            inboundPreviewItems.reduce((acc, item) => {
              ...
              acc = acc + Number(((_b = action == null ? void 0 : action.details) == null ? void 0 : _b.quantity) || 0) / item.quantity * item.total;
              return acc;
            }, 0) * -1,
            order.currency_code
          ) })
        ...
        (0, import_jsx_runtime9.jsxs)("div", { className: "mt-4 flex items-center justify-between border-t border-dotted pt-4", children: [
          ...
          (0, import_jsx_runtime9.jsx)("span", { className: "txt-small font-medium", children: getStylizedAmount(estimatedDifference, order.currency_code) })
        ] })
      ] }),
      hasPromotions && (0, import_jsx_runtime9.jsx)("div", { className: "bg-ui-bg-field mt-4 rounded-lg border py-2 pl-2 pr-4", children: (0, import_jsx_runtime9.jsx)(
        Form.Field,
        {
          control: form.control,
            ...
            return (0, import_jsx_runtime9.jsxs)(Form.Item, { children: [
              (0, import_jsx_runtime9.jsxs)("div", { className: "flex items-center", children: [
                (0, import_jsx_runtime9.jsx)(Form.Control, { className: "mr-4 self-start", children: (0, import_jsx_runtime9.jsx)(
                  Switch,
                  {
                    ...
                    onCheckedChange: async (checked) => {
                      var _a2;
                      onChange(checked);
                      if ((_a2 = preview == null ? void 0 : preview.order_change) == null ? void 0 : _a2.id) {
                ...
                (0, import_jsx_runtime9.jsxs)("div", { className: "block", children: [
                  (0, import_jsx_runtime9.jsxs)(Form.Label, { className: "flex items-center gap-x-2", children: [
                    t2("orders.exchanges.carryOverPromotion"),
                    (0, import_jsx_runtime9.jsx)(Form.Hint, { children: (0, import_jsx_runtime9.jsx)(
                      Tooltip,
                      {
                        content: t2(
                          "orders.exchanges.carryOverPromotionTooltip"
                        ),
                        children: (0, import_jsx_runtime9.jsx)(InformationCircleSolid, {})
                      }
                    ) })
                  ] }),
                  (0, import_jsx_runtime9.jsx)(Form.Hint, { className: "!mt-1", children: t2("orders.exchanges.carryOverPromotionHint") })
                ] })
              ] }),
...
var ExchangeCreate = () => {
  ...
  const { mutateAsync: createExchange } = useCreateExchange((order == null ? void 0 : order.id) ?? "");
  ...
  (0, import_react.useEffect)(() => {
    async function run() {
      ...
      try {
        ...
        toast.error(
          e instanceof Error ? e.message : t2("errorBoundary.defaultTitle")
        );
        navigate(`/orders/${preview.id}`, { replace: true });
      } finally {
...
//# sourceMappingURL=order-create-exchange-XYY7APKS-45GBW6MZ.js.map
