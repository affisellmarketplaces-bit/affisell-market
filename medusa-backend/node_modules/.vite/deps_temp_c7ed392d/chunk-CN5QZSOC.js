...
// node_modules/@medusajs/dashboard/dist/chunk-4Y6PJMQD.mjs
...
var ConditionalPriceSchema = external_exports.object({
  amount: external_exports.union([external_exports.string(), external_exports.number()]),
  gte: external_exports.union([external_exports.string(), external_exports.number()]).nullish(),
  lte: external_exports.union([external_exports.string(), external_exports.number()]).nullish(),
  lt: external_exports.number().nullish(),
  gt: external_exports.number().nullish(),
  eq: external_exports.number().nullish()
...
var CondtionalPriceRuleSchema = external_exports.object({
  prices: external_exports.array(ConditionalPriceSchema)
}).superRefine(refineDuplicates);
var UpdateConditionalPriceRuleSchema = external_exports.object({
  prices: external_exports.array(UpdateConditionalPriceSchema)
}).superRefine(refineDuplicates);
...
//# sourceMappingURL=chunk-CN5QZSOC.js.map
