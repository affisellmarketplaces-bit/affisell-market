...
// node_modules/@medusajs/dashboard/dist/order-create-claim-K5PLQ2RZ.mjs
...
var ClaimCreateSchema = external_exports.object({
...
var ClaimOutboundSection = ({
  ...
  return (0, import_jsx_runtime7.jsxs)("div", { children: [
    ...
    outboundItems.map(
      (item, index) => item.variant_id && variantOutboundMap.get(item.variant_id) && (0, import_jsx_runtime7.jsx)(
        ClaimOutboundItem,
        {
...
var ClaimCreateForm = ({
  ...
  const { mutateAsync: updateOrderChange } = useUpdateOrderChange(
    (_b = preview == null ? void 0 : preview.order_change) == null ? void 0 : _b.id,
    {
      onError: (error) => {
        toast.error(error.message);
      }
      ...
      return Promise.resolve({
        inbound_items: inboundPreviewItems.map((i) => {
          ...
          return {
            ...
            reason_id: (_b2 = inboundAction == null ? void 0 : inboundAction.details) == null ? void 0 : _b2.reason_id
          };
        }),
      ...
      if (ind > -1) {
        if (inboundItems[ind].quantity !== i.detail.return_requested_quantity) {
          ...
          update(ind, {
            ...
            reason_id: (_b2 = returnItemAction == null ? void 0 : returnItemAction.details) == null ? void 0 : _b2.reason_id
          });
        }
      } else {
        append(
  ...
  const onItemsSelected = async () => {
    ...
    for (const itemToRemove of itemsToRemove2) {
      const actionId = (_c = (_b2 = (_a2 = previewItems.find((i) => i.id === itemToRemove)) == null ? void 0 : _a2.actions) == null ? void 0 : _b2.find((a) => a.action === "RETURN_ITEM")) == null ? void 0 : _c.id;
      if (actionId) {
  ...
  const showLevelsWarning = (0, import_react2.useMemo)(() => {
    ...
    const allItemsHaveLocation = inboundItems.map((_i) => {
      ...
      return (_b2 = inventoryMap[item.variant_id]) == null ? void 0 : _b2.find(
        (l) => l.location_id === locationId
      );
    }).every(Boolean);
    return !allItemsHaveLocation;
  ...
  (0, import_react2.useEffect)(() => {
    const getInventoryMap = async () => {
      ...
      variants.forEach((variant) => {
        var _a2, _b2;
        ret[variant.id] = ((_b2 = (_a2 = variant.inventory) == null ? void 0 : _a2[0]) == null ? void 0 : _b2.location_levels) || [];
      });
      return ret;
    };
    getInventoryMap().then((map) => {
    ...
    (0, import_jsx_runtime8.jsx)(RouteFocusModal.Body, { className: "flex size-full justify-center overflow-y-auto", children: (0, import_jsx_runtime8.jsxs)("div", { className: "mt-16 w-[720px] max-w-[100%] px-4 md:p-0", children: [
      ...
      inboundItems.map(
        (item, index) => previewItemsMap.get(item.item_id) && itemsMap.get(item.item_id) && (0, import_jsx_runtime8.jsx)(
          ClaimInboundItem,
          {
            ...
            onRemove: () => {
              var _a2, _b2, _c;
              const actionId = (_c = (_b2 = (_a2 = previewItems.find((i) => i.id === item.item_id)) == null ? void 0 : _a2.actions) == null ? void 0 : _b2.find((a) => a.action === "RETURN_ITEM")) == null ? void 0 : _c.id;
              if (actionId) {
            ...
            onUpdate: (payload) => {
              var _a2, _b2;
              const action = (_b2 = (_a2 = previewItems.find((i) => i.id === item.item_id)) == null ? void 0 : _a2.actions) == null ? void 0 : _b2.find((a) => a.action === "RETURN_ITEM");
              if (action) {
                updateInboundItem(
                    ...
                    onError: (error) => {
                      ...
                      if (((_a3 = action.details) == null ? void 0 : _a3.quantity) && payload.quantity) {
                        form.setValue(
                          ...
                          (_b3 = action.details) == null ? void 0 : _b3.quantity
                        );
                      }
                      toast.error(error.message);
                    }
      ...
      (0, import_jsx_runtime8.jsxs)("div", { className: "mt-8 border-y border-dotted py-4", children: [
        (0, import_jsx_runtime8.jsxs)("div", { className: "mb-2 flex items-center justify-between", children: [
          ...
          (0, import_jsx_runtime8.jsx)("span", { className: "txt-small text-ui-fg-subtle", children: getStylizedAmount(
            inboundPreviewItems.reduce((acc, item) => {
              ...
              acc = acc + Number((action == null ? void 0 : action.amount) || 0);
              return acc;
            }, 0) * -1,
            order.currency_code
          ) })
        ...
        (0, import_jsx_runtime8.jsxs)("div", { className: "mt-4 flex items-center justify-between border-t border-dotted pt-4", children: [
          ...
          (0, import_jsx_runtime8.jsx)("span", { className: "txt-small font-medium", children: getStylizedAmount(estimatedDifference, order.currency_code) })
        ] })
      ] }),
      hasPromotions && (0, import_jsx_runtime8.jsx)("div", { className: "bg-ui-bg-field mt-4 rounded-lg border py-2 pl-2 pr-4", children: (0, import_jsx_runtime8.jsx)(
        Form.Field,
        {
          control: form.control,
            ...
            return (0, import_jsx_runtime8.jsxs)(Form.Item, { children: [
              (0, import_jsx_runtime8.jsxs)("div", { className: "flex items-center", children: [
                ...
                (0, import_jsx_runtime8.jsxs)("div", { className: "block", children: [
                  (0, import_jsx_runtime8.jsxs)(Form.Label, { className: "flex items-center gap-x-2", children: [
                    t2("orders.claims.carryOverPromotion"),
                    (0, import_jsx_runtime8.jsx)(Form.Hint, { children: (0, import_jsx_runtime8.jsx)(
                      Tooltip,
                      {
                        content: t2(
                          "orders.claims.carryOverPromotionTooltip"
                        ),
                        children: (0, import_jsx_runtime8.jsx)(InformationCircleSolid, {})
                      }
                    ) })
                  ] }),
                  (0, import_jsx_runtime8.jsx)(Form.Hint, { className: "!mt-1", children: t2("orders.claims.carryOverPromotionHint") })
                ] })
              ] }),
...
var ClaimCreate = () => {
  ...
  const { mutateAsync: createClaim } = useCreateClaim((order == null ? void 0 : order.id) ?? "");
...
//# sourceMappingURL=order-create-claim-K5PLQ2RZ-XGSPKJ73.js.map
