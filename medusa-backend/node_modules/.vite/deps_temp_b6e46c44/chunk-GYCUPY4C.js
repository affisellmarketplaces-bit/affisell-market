...
// node_modules/@medusajs/dashboard/dist/chunk-KAGRE2I5.mjs
...
var useReferenceValues = (type, ids) => {
  ...
  const shippingOptions = useShippingOptions(
    ...
    {
      enabled: !!ids.length && type === "shipping_option"
      /* SHIPPING_OPTION */
    }
  );
  ...
  switch (type) {
    ...
    case "shipping_option":
      return {
        labels: (_c = shippingOptions.shipping_options) == null ? void 0 : _c.map((option) => option.name),
...
//# sourceMappingURL=chunk-GYCUPY4C.js.map
