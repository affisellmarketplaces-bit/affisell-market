...
// node_modules/@medusajs/dashboard/dist/product-variant-media-IZS7KEHH.mjs
...
var EditProductVariantMediaForm = ({
  ...
  const allVariantImages = (variant.images || []).filter(
    (image) => {
      var _a2;
      return (_a2 = image.variants) == null ? void 0 : _a2.some((imageVariant) => imageVariant.id === variant.id);
    }
  );
  ...
  const isSelectedImageThumbnail = variant.thumbnail && Object.keys(selection).length === 1 && selectedImageThumbnail === ((_c = (_b = variant.images) == null ? void 0 : _b.find((image) => image.id === Object.keys(selection)[0])) == null ? void 0 : _c.url);
...
var ProductVariantMedia = () => {
  ...
  return (0, import_jsx_runtime2.jsx)(RouteFocusModal, { children: ready && (0, import_jsx_runtime2.jsx)(EditProductVariantMediaForm, { variant }) });
};
export {
  ProductVariantMedia as Component
};
//# sourceMappingURL=product-variant-media-IZS7KEHH-D33PEAPW.js.map
