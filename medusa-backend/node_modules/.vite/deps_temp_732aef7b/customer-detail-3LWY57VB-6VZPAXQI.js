...
} from "./chunk-YSHVYGKH.js";
import {
  useOrderTableColumns
} from "./chunk-MOP4IOAI.js";
import "./chunk-J5IH77FO.js";
import {
  useCustomerGroupTableQuery
} from "./chunk-IZUP7Z3D.js";
import {
  useOrderTableQuery
} from "./chunk-MPOJTWZH.js";
import {
  useOrderTableFilters
} from "./chunk-IC7XSRGY.js";
import {
  useCustomerGroupTableFilters
} from "./chunk-X3NWJ4KS.js";
...
// node_modules/@medusajs/dashboard/dist/customer-detail-3LWY57VB.mjs
...
var CustomerAddressSection = ({
  ...
  return (0, import_jsx_runtime3.jsxs)(Container, { className: "p-0", children: [
    (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center justify-between px-6 py-4", children: [
      ...
      (0, import_jsx_runtime3.jsx)(PermissionGuard, { resource: "customer", operation: "update", children: (0, import_jsx_runtime3.jsx)(Link, { to: `create-address`, className: "text-ui-fg-muted text-xs", children: "Add" }) })
    ] }),
    ...
    addresses.map((address) => {
      return (0, import_jsx_runtime3.jsx)(
        Listicle,
        {
          ...
          children: canDelete && (0, import_jsx_runtime3.jsx)(
            ActionMenu,
            {
              groups: [
                {
  ...
  return (0, import_jsx_runtime4.jsxs)(Container, { className: "divide-y p-0", children: [
    (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center justify-between px-6 py-4", children: [
      ...
      (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center gap-x-2", children: [
        ...
        groups.length > 0 && (0, import_jsx_runtime4.jsx)(ActionMenu, { groups })
      ] })
    ] }),
...
var CustomerGroupSection = ({
  ...
  const [rowSelection, setRowSelection] = (0, import_react2.useState)({});
  ...
  return (0, import_jsx_runtime5.jsxs)(Container, { className: "divide-y p-0", children: [
    (0, import_jsx_runtime5.jsxs)("div", { className: "flex items-center justify-between px-6 py-4", children: [
      ...
      (0, import_jsx_runtime5.jsx)(PermissionGuard, { resource: "customer", operation: "update", children: (0, import_jsx_runtime5.jsx)(Link, { to: `/customers/${customer.id}/add-customer-groups`, children: (0, import_jsx_runtime5.jsx)(Button, { variant: "secondary", size: "small", children: t("general.add") }) }) })
    ] }),
...
var CustomerDetail = () => {
  ...
  return (0, import_jsx_runtime7.jsx)(PermissionsRequirementsProvider, { children: (0, import_jsx_runtime7.jsxs)(
    TwoColumnPage,
    {
      widgets: {
...
//# sourceMappingURL=customer-detail-3LWY57VB-6VZPAXQI.js.map
