...
var require_use_sync_external_store_shim_production = _7FULUV5Lcjs.__commonJS.call(void 0, {
  "../../node_modules/.pnpm/use-sync-external-store@1.6.0_react@19.2.7/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.production.js"(exports) {
    "use strict";
    var React2 = _7FULUV5Lcjs.__require.call(void 0, "react");
    function is(x, y) {
...
var require_use_sync_external_store_shim_development = _7FULUV5Lcjs.__commonJS.call(void 0, {
...
var require_shim = _7FULUV5Lcjs.__commonJS.call(void 0, {
...
function getInternal(store, key) {
  ...
  _7FULUV5Lcjs.invariant.call(void 0, internals, "Invalid store");
...
function createStore(initialState, ...stores) {
  ...
  const storeInit = () => {
    ...
    const stateKeys = _7FULUV5Lcjs.getKeys.call(void 0, state);
    const desyncs = [];
    for (const store of stores) {
      const storeState = (_a = store == null ? void 0 : store.getState) == null ? void 0 : _a.call(store);
      if (!storeState) continue;
      const keys = stateKeys.filter((key) => _7FULUV5Lcjs.hasOwnProperty.call(void 0, storeState, key));
    ...
    destroy = _7FULUV5Lcjs.chain.call(void 0, ...desyncs, ...teardowns, ...cleanups);
    return maybeDestroy;
  };
  ...
  const storePick = (keys) => createStore(_7FULUV5Lcjs.pick.call(void 0, state, keys), finalStore);
  const storeOmit = (keys) => createStore(_7FULUV5Lcjs.omit.call(void 0, state, keys), finalStore);
  ...
  const setState = (key, value, fromStores = false) => {
    var _a;
    if (!_7FULUV5Lcjs.hasOwnProperty.call(void 0, state, key)) return;
...
function throwOnConflictingProps(props, store) {
  ...
  if (!defaultKeys.filter((key) => _7FULUV5Lcjs.hasOwnProperty.call(void 0, storeState, key)).length) return;
...
var import_shim = _7FULUV5Lcjs.__toESM.call(void 0, require_shim(), 1);
var _react = require('react'); var React = _interopRequireWildcard(_react);
var noopSubscribe = () => () => {
};
function useStoreState(store, keyOrSelector = _7FULUV5Lcjs.identity) {
  ...
  const getSnapshot = () => {
    ...
    for (const prop in object) {
      ...
      if (typeof keyOrSelector === "string") {
        if (!state) continue;
        if (!_7FULUV5Lcjs.hasOwnProperty.call(void 0, state, keyOrSelector)) continue;
...
function useStoreProps(store, props, key, setKey) {
  const value = _7FULUV5Lcjs.hasOwnProperty.call(void 0, props, key) ? props[key] : void 0;
  const propsRef = _7FULUV5Lcjs.useLiveRef.call(void 0, {
    value,
...
function useStore(createStore2, props) {
  ...
  _7FULUV5Lcjs.useSafeLayoutEffect.call(void 0, () => init(store), [store]);
  const useState2 = React.useCallback((keyOrSelector) => useStoreState(store, keyOrSelector), [store]);
  return [React.useMemo(() => ({
    ...store,
    useState: useState2
  }), [store, useState2]), _7FULUV5Lcjs.useEvent.call(void 0, () => {
