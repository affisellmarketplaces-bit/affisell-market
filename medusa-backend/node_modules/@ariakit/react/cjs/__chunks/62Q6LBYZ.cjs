...
function useDisableEvent(onEvent, disabled) {
  return _7FULUV5Lcjs.useEvent.call(void 0, (event) => {
...
function onGlobalMouseDown(event) {
  ...
  if (_7FULUV5Lcjs.isElement.call(void 0, target) && !target.hasAttribute("data-focus-visible")) isKeyboardModality = false;
}
...
var useFocusable = _7FULUV5Lcjs.createHook.call(void 0, function useFocusable2({ focusable = true, accessibleWhenDisabled, autoFocus, onFocusVisible, ...props }) {
  const ref = _react.useRef.call(void 0, null);
  const [parentAccessibleWhenDisabled, metadataProps] = _7FULUV5Lcjs.useMetadataProps.call(void 0, props, accessibleWhenDisabledSymbol, accessibleWhenDisabled);
  ...
  _react.useEffect.call(void 0, () => {
    ...
    _7FULUV5Lcjs.addGlobalEventListener.call(void 0, "mousedown", onGlobalMouseDown, true);
    _7FULUV5Lcjs.addGlobalEventListener.call(void 0, "keydown", onGlobalKeyDown, true);
    hasInstalledGlobalEventListeners = true;
  }, [focusable]);
  const disabled = focusable && _7FULUV5Lcjs.disabledFromProps.call(void 0, props);
  ...
  const cleanupFocusVisible = _7FULUV5Lcjs.useEvent.call(void 0, (element) => {
    var _a;
  ...
  _react.useEffect.call(void 0, () => {
    ...
    const observer = new IntersectionObserver(() => {
      if (!_7FULUV5Lcjs.isFocusable.call(void 0, element)) {
        focusVisibleRef.current = false;
  ...
  const handleFocusVisible = (event, currentTarget) => {
    ...
    if (!element) return;
    if (!_7FULUV5Lcjs.hasFocus.call(void 0, element)) return;
    ...
    if (isNativeSubmitControl(element)) {
      ...
      if (typeof IntersectionObserver !== "undefined") {
        const observer = new IntersectionObserver(() => {
          if (_7FULUV5Lcjs.isFocusable.call(void 0, element)) return;
  ...
  const onKeyDownCapture = _7FULUV5Lcjs.useEvent.call(void 0, (event) => {
    ...
    if (event.altKey) return;
    if (event.ctrlKey) return;
    if (!_7FULUV5Lcjs.isSelfTarget.call(void 0, event)) return;
    const element = event.currentTarget;
    const applyFocusVisible = () => handleFocusVisible(event, element);
    _7FULUV5Lcjs.queueBeforeEvent.call(void 0, element, "focusout", applyFocusVisible);
  });
  const onFocusCaptureProp = props.onFocusCapture;
  const onFocusCapture = _7FULUV5Lcjs.useEvent.call(void 0, (event) => {
    onFocusCaptureProp == null ? void 0 : onFocusCaptureProp(event);
    if (event.defaultPrevented) return;
    if (!focusable) return;
    if (!_7FULUV5Lcjs.isSelfTarget.call(void 0, event)) {
      setFocusVisible(false);
      return;
    }
    const element = event.currentTarget;
    const applyFocusVisible = () => handleFocusVisible(event, element);
    if (isKeyboardModality || isAlwaysFocusVisible(event.target)) _7FULUV5Lcjs.queueBeforeEvent.call(void 0, event.target, "focusout", applyFocusVisible);
  ...
  const onBlur = _7FULUV5Lcjs.useEvent.call(void 0, (event) => {
    ...
    if (!focusable) return;
    if (!_7FULUV5Lcjs.isFocusEventOutside.call(void 0, event)) return;
    cleanupFocusVisible(event.currentTarget);
    setFocusVisible(false);
  });
  const autoFocusOnShow = _react.useContext.call(void 0, FocusableContext);
  const autoFocusRef = _7FULUV5Lcjs.useEvent.call(void 0, (element) => {
    if (!focusable) return;
    if (!autoFocus) return;
    if (!element) return;
  ...
  const tagName = _7FULUV5Lcjs.useTagName.call(void 0, ref);
  ...
  props = {
    ...
    ...props,
    ...metadataProps,
    ref: _7FULUV5Lcjs.useMergeRefs.call(void 0, ref, autoFocusRef, props.ref),
    style,
  ...
  return _7FULUV5Lcjs.removeUndefinedValues.call(void 0, props);
});
var Focusable = _7FULUV5Lcjs.forwardRef.call(void 0, function Focusable2(props) {
  return _7FULUV5Lcjs.createElement.call(void 0, TagName, useFocusable(props));
});
