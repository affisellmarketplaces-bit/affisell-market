...
function getFlipMiddleware(props) {
  ...
  _7FULUV5Lcjs.invariant.call(void 0, !fallbackPlacements || fallbackPlacements.every(isValidPlacement), process.env.NODE_ENV !== "production" && "`flip` expects a spaced-delimited list of placements");
  return flip2({
...
var usePopover = _7FULUV5Lcjs.createHook.call(void 0, function usePopover2({ store, modal = false, portal = modal, preserveTabOrder = true, autoFocusOnShow = true, wrapperProps, fixed = false, flip: flip3 = true, shift: shift3 = 0, slide = true, overlap = false, sameWidth = false, fitViewport = false, gutter, arrowPadding = 4, overflowPadding = 8, getAnchorRect, updatePosition, ...props }) {
  const context = _5X2KE4NBcjs.usePopoverProviderContext.call(void 0, );
  store = store || context;
  _7FULUV5Lcjs.invariant.call(void 0, store, process.env.NODE_ENV !== "production" && "Popover must receive a `store` prop or be wrapped in a PopoverProvider component.");
  const arrowElement = _TJNZ4CWTcjs.useStoreState.call(void 0, store, "arrowElement");
  const anchorElement = _TJNZ4CWTcjs.useStoreState.call(void 0, store, "anchorElement");
  const disclosureElement = _TJNZ4CWTcjs.useStoreState.call(void 0, store, "disclosureElement");
  const popoverElement = _TJNZ4CWTcjs.useStoreState.call(void 0, store, "popoverElement");
  const contentElement = _TJNZ4CWTcjs.useStoreState.call(void 0, store, "contentElement");
  const placement = _TJNZ4CWTcjs.useStoreState.call(void 0, store, "placement");
  const mounted = _TJNZ4CWTcjs.useStoreState.call(void 0, store, "mounted");
  const rendered = _TJNZ4CWTcjs.useStoreState.call(void 0, store, "rendered");
  ...
  const getAnchorRectProp = _7FULUV5Lcjs.useEvent.call(void 0, getAnchorRect);
  const updatePositionProp = _7FULUV5Lcjs.useEvent.call(void 0, updatePosition);
  ...
  props = _7FULUV5Lcjs.useWrapElement.call(void 0, props, (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", {
    ...wrapperProps,
    style: {
      position,
      top: 0,
  ...
  props = _7FULUV5Lcjs.useWrapElement.call(void 0, props, (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _5X2KE4NBcjs.PopoverScopedContextProvider, {
    value: store,
    children: element
  }), [store]);
  props = {
  ...
  props = _PYQLHI47cjs.useDialog.call(void 0, {
    store,
    modal,
    portal,
    preserveTabOrder,
...
var Popover = _PYQLHI47cjs.createDialogComponent.call(void 0, _7FULUV5Lcjs.forwardRef.call(void 0, function Popover2(props) {
  return _7FULUV5Lcjs.createElement.call(void 0, TagName, usePopover(props));
}), _5X2KE4NBcjs.usePopoverProviderContext);

// ../ariakit-components/dist/popover/popover-store.js
function createPopoverStore({ popover: otherPopover, ...props } = {}) {
  const store = _TJNZ4CWTcjs.mergeStore.call(void 0, props.store, _TJNZ4CWTcjs.omit.call(void 0, otherPopover, [
    "arrowElement",
    "anchorElement",
    "contentElement",
    "popoverElement",
  ...
  _TJNZ4CWTcjs.throwOnConflictingProps.call(void 0, props, store);
  const syncState = store == null ? void 0 : store.getState();
  const dialog = _PYQLHI47cjs.createDialogStore.call(void 0, {
    ...props,
    store
  });
  const placement = _7FULUV5Lcjs.defaultValue.call(void 0, props.placement, syncState == null ? void 0 : syncState.placement, "bottom");
  const popover = _TJNZ4CWTcjs.createStore.call(void 0, {
    ...dialog.getState(),
    placement,
    currentPlacement: placement,
    anchorElement: _7FULUV5Lcjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.anchorElement, null),
    popoverElement: _7FULUV5Lcjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.popoverElement, null),
    arrowElement: _7FULUV5Lcjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.arrowElement, null),
...
function usePopoverStoreProps(store, update, props) {
  _7FULUV5Lcjs.useUpdateEffect.call(void 0, update, [props.popover]);
  _TJNZ4CWTcjs.useStoreProps.call(void 0, store, props, "placement");
  return _PYQLHI47cjs.useDialogStoreProps.call(void 0, store, update, props);
}
function usePopoverStore(props = {}) {
  const [store, update] = _TJNZ4CWTcjs.useStore.call(void 0, createPopoverStore, props);
