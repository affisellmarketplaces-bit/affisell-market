 ...
 * ```
 */
declare const useTabPanel: import("@ariakit/react-utils").Hook<"div", TabPanelOptions<"div">>;
/**
...
type TabPanelProps<T extends ElementType = TagName> = Props<T, TabPanelOptions<T>>;
//#endregion
export { TabPanel, TabPanelOptions, TabPanelProps, useTabPanel };
