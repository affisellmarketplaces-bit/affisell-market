...
import { createElement, createHook, forwardRef, useBooleanEvent, useEvent, useMergeRefs, useWrapElement } from "@ariakit/react-utils";
import { getPopupRole, invariant, queueBeforeEvent, toArray } from "@ariakit/utils";
...
const Select = forwardRef(function Select(props) {
	return createElement(TagName, useSelect(props));
});
//#endregion
