 ...
 * ```
 */
declare const useMenuList: import("@ariakit/react-utils").Hook<"div", MenuListOptions<"div">>;
/**
...
type MenuListProps<T extends ElementType = TagName> = Props<T, MenuListOptions<T>>;
//#endregion
export { MenuList, MenuListOptions, MenuListProps, useMenuList };
