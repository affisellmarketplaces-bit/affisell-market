"use client";
import { addGlobalEventListener, canUseDOM, hasOwnProperty } from "@ariakit/utils";
...
function useLazyValue(init) {
	...
	if (ref.current === void 0) ref.current = init();
	return ref.current;
}
/**
...
function usePreviousValue(value) {
	...
	if (value !== previousValue) setPreviousValue(value);
...
//#endregion
export { createElement, createHook, createStoreContext, forwardRef, getRefProperty, isValidElementWithRef, memo, mergeProps, setRef, useAttribute, useBooleanEvent, useDeferredValue, useEvent, useForceUpdate, useId, useInitialValue, useIsMouseMoving, useLazyValue, useLiveRef, useMergeRefs, useMetadataProps, usePortalRef, usePreviousValue, useSafeLayoutEffect, useTagName, useTransactionState, useUpdateEffect, useUpdateLayoutEffect, useWrapElement };
