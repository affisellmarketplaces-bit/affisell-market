...
export type BookingReminderEmailCopy = {
  preview: string
  heading: string
  intro: string
  cta: string
    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          <Section style={glow}>
            <Text style={badge}>◷ Affisell Booking</Text>
            ...
            <Section style={whenBox}>
              ...
              {seatLabels.length > 0 ? (
                <>
                  <Text style={whenTitle}>{copy.seatsLabel}</Text>
                  <Text style={whenBody}>{seatLabels.join(" · ")}</Text>
                </>
              ) : null}
            </Section>
