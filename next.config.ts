...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/legal/mentions", destination: "/legal/mentions-legales", permanent: true },
      ...
      /** CGA = affilié · CGS = fournisseur (conventions Affisell FR). */
      { source: "/cga", destination: "/conditions-affilie", permanent: true },
      { source: "/cgs", destination: "/conditions-fournisseur", permanent: true },
